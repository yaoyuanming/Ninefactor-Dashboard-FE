<template>
  <div class="node-handler-wrapper">
    <div class="node-handler">
      <el-popover
        :disabled="!modelItem?.allowUpdateProcess"
        trigger="hover"
      ...
      >
        ...
        <template #reference>
          <div class="add-icon" v-if="modelItem?.allowUpdateProcess"><Icon icon="ep:plus"/></div>
        </template>
      </el-popover>
    </div>
  </div>
