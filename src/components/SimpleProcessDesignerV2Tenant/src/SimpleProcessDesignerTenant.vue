...
import SimpleProcessModelTenant from './SimpleProcessModelTenant.vue'
import { SimpleFlowNode, NodeType, NodeId, NODE_DEFAULT_TEXT } from './consts'
import { getModel } from '@/api/bpm/modelTenant'
...
defineOptions({
  name: 'SimpleProcessDesignerTenant'
})
