<template>
  ...
  <StartUserNodeConfigTenant v-if="!readonly && currentNode" ref="nodeSetting" :flow-node="currentNode" />
  <!-- 审批记录 -->
  <el-dialog
...
import StartUserNodeConfigTenant from '../nodes-config/StartUserNodeConfigTenant.vue'
import { dateFormatter, formatPast2 } from '@/utils/formatTime'
import { DICT_TYPE } from '@/utils/dict'
defineOptions({
  name: 'StartEventNodeTenant'
})
