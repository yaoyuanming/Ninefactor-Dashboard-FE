<template>
  <div class="simple-process-model-container position-relative">
    ...
    >
      <ProcessNodeTree v-if="processNodeTree" v-model:flow-node="processNodeTree" :model-item="modelItem" />
    </div>
  </div>
...
import ProcessNodeTree from './ProcessNodeTreeTenant.vue'
