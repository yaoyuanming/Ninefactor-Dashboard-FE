    ...
    <div>
      <el-form ref="formRef" :model="configForm" label-position="top" :rules="formRules">
        ...
        <div
          ...
          "
        >
          <HttpRequestSettingTenantTenant
...
import HttpRequestSettingTenantTenant from './components/HttpRequestSettingTenant.vue'
import ConditionDialogTenant from './components/ConditionDialogTenant.vue'
const { proxy } = getCurrentInstance() as any

defineOptions({
  name: 'TriggerNodeConfigTenant'
})
