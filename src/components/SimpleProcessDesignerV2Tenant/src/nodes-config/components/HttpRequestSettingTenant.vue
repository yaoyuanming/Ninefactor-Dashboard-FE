<template>
  ...
  <!-- 请求头，请求体设置-->
  <HttpRequestParamSettingTenant :header="setting.header" :body="setting.body" :bind="formItemPrefix" />
  <!-- 返回值设置-->
...
import HttpRequestParamSettingTenant from './HttpRequestParamSettingTenant.vue'
