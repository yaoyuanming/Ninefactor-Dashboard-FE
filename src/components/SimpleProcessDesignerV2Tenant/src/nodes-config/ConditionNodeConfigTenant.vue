<template>
  ...
  >
    ...
    <div>
      ...
      >
      <div v-else>
        <ConditionTenantTenant ref="conditionRef" v-model="condition" />
      </div>
    </div>
    <template #footer>
      <el-divider />
...
import ConditionTenantTenant from './components/ConditionTenant.vue'
import { cloneDeep } from 'lodash-es'

defineOptions({
  name: 'ConditionNodeConfigTenant'
})
