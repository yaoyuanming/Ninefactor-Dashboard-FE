  ...
  <div class="pt-20px">
    <el-timeline>
      ...
      >
        ...
        <template #dot>
          <span :style="{ backgroundColor: getClientTypeColor(log.clientType) }" class="dot-node-style">
            {{ getDictLabel(DICT_TYPE.CLIENT_TYPE, log.clientType)[0] }}
          </span>
        </template>
      </el-timeline-item>
    </el-timeline>
...
const getClientTypeColor = (type: number) => {
  const dict = getDictObj(DICT_TYPE.CLIENT_TYPE, type)
