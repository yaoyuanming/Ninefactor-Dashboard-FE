<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      <el-table-column label="客户端编号" align="center" prop="clientId" width="200" />
      <el-table-column label="客户端密钥" align="center" prop="secret" width="200" />
      <el-table-column label="应用名" align="center" prop="name" width="200" />
      <el-table-column label="应用图标" align="center" prop="logo" width="80">
        <template #default="scope">
          <img width="40px" height="40px" :src="scope.row.logo" />
        </template>
      </el-table-column>
      <el-table-column label="访问令牌有效期" align="center" prop="accessTokenValiditySeconds" width="130">
        <template #default="scope">{{ scope.row.accessTokenValiditySeconds }} 秒</template>
      </el-table-column>
      <el-table-column label="刷新令牌有效期" align="center" prop="refreshTokenValiditySeconds" width="130">
