              ...
              <el-scrollbar>
                <el-row>
                  <el-col :span="17" class="!flex !flex-col formCol">
                    ...
                    >
                      <MyExtend :items="MyContent" v-if="formSetting?.taskFormType == 0" />
...
import { FieldPermissionType } from '@/components/SimpleProcessDesignerV2Tenant/src/consts'
...
import MyExtend from './Extend.vue'
...
const getApprovalDetail = async () => {
  ...
  try {
    ...
    formSetting.value = data.formSetting
    MyContent.value = {
      basicContent: data.processInstance.basicContent,
      expandContent: data.processInstance.expandContent
    }
    // 设置表单信息
