<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="文件业务类型" label-width="100px" prop="bizType">
        <el-select
        ...
        >
          <el-option
            ...
            :key="dictType.category"
            :label="dictType.name"
            :value="dictType.category"
          />
        </el-select>
      </el-form-item>
      <el-form-item label="二级业务类型" label-width="100px" prop="bizTypeSec">
        <el-select
          v-model="queryParams.bizTypeSec"
          clearable
      ...
      <el-form-item>
        ...
        <el-button type="primary" plain @click="openFormBiz('create')">
      ...
      <el-table-column label="操作" align="center">
        <template #default="scope">
          ...
          <el-button
            link
            type="primary"
            @click="openFormBiz('update', scope.row.id)"
  ...
  <!-- 表单弹窗：添加/修改业务文件 -->
  <FileFormBiz ref="formBizRef" @success="getList" />
</template>
...
import FileFormBiz from './FileFormBiz.vue'
...
/** 添加/修改业务文件 */
const formBizRef = ref()
const openFormBiz = (type: string, id?: number) => {
  formBizRef.value.open(type, id)
}
