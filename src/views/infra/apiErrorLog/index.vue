<template>
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="客户端" prop="clientType">
        ...
        >
          <el-option
            v-for="dict in getIntDictOptions(DICT_TYPE.CLIENT_TYPE)"
            :key="dict.value"
            :label="dict.label"
            :value="dict.value"
          />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list">
      ...
      <el-table-column label="客户端" align="center" prop="clientType" width="80">
        <template #default="scope">
          <dict-tag :type="DICT_TYPE.CLIENT_TYPE" :value="scope.row.clientType" />
        </template>
      </el-table-column>
      ...
      <el-table-column label="请求地址" align="center" prop="requestUrl" width="300" />
      <el-table-column
        label="异常发生时间"
        align="center"
        prop="exceptionTime"
      ...
      />
      <el-table-column label="异常名" align="center" prop="exceptionName" width="400" />
