    ...
    <el-row :gutter="24">
        ...
        <el-menu default-active="2" class="el-menu-vertical-demo" style="height: 100%">
          ...
          >
            <div
              ...
              "
            >
              <span>{{ item.riskUnitName }}</span>
              <el-dropdown v-if="item.id != null">
                <span class="el-dropdown-link">
                  <Icon
                    icon="ep:more-filled"
                    style="border: 1px solid #bccafc; border-radius: 20%; background: #bccafc"
                  />
                </span>
                <template #dropdown>
                  <el-dropdown-menu>
      ...
      <el-col :span="20">
        ...
        >
          ...
          <el-table-column label="整体风险等级" align="center" prop="overallRisk">
          ...
          <el-table-column label="管控层级" align="center" prop="controlLevel">
            <template #default="scope">
              {{ getValue(scope.row.controlLevel) }}
            </template>
          </el-table-column>
          <el-table-column label="责任部门名称" align="center" prop="respDeptName" />
          <el-table-column label="管控责任人" align="center" prop="respUserName" />
          <el-table-column label="操作" align="center" min-width="200px" fixed="right">
            <template #default="scope">
              ...
              <el-dropdown style="margin-top: 2px; margin-left: 15px">
                  ...
                  <el-dropdown-menu>
                    ...
                    <el-dropdown-item @click="openForm('create', scope.row.id, 3)">
                      <el-button
                        ...
                        type="primary"
                        plain
                        v-hasPermi="['prt:risk:export:list']"
                      >
                        导出风险分级管控清单
                      </el-button>
                    </el-dropdown-item>
...
const getList = async () => {
  loading.value = true
  try {
    const data = await RiskApi.getRiskPage(queryParams.value)
...
const getStat = async () => {
  RiskStat.value = await RiskApi.getStat()
}
/** 初始化 **/
onMounted(async () => {
  await getRiskLevel1()
