<template>
  <el-form ref="formRef" :model="modelData" label-width="270px" class="mt-20px">
    ...
    <el-form-item class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">允许租户修改基本信息</el-text>
      </template>
      <div class="flex flex-col w-100%">
        <div class="flex">
          <el-switch
            v-model="modelData.allowUpdateBasicInfo"
          />
        </div>
      </div>
    </el-form-item>
    <el-form-item class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">允许租户修改更多设置</el-text>
      </template>
      <div class="flex flex-col w-100%">
        <div class="flex">
          <el-switch
            v-model="modelData.allowUpdateExtraSetting"
          />
        </div>
      </div>
    </el-form-item>
    <el-form-item class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">允许租户修改流程设计</el-text>
      </template>
      <div class="flex flex-col w-100%">
        <div class="flex">
          <el-switch
            v-model="modelData.allowUpdateProcess"
          />
        </div>
      </div>
    </el-form-item>
    <el-form-item class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">允许租户修改流程节点操作按钮设置</el-text>
      </template>
      <div class="flex flex-col w-100%">
        <div class="flex">
          <el-switch
            v-model="modelData.allowUpdateNodeButtonsSetting"
          />
        </div>
      </div>
    </el-form-item>
    <el-form-item class="mb-20px">
      <template #label>
        <el-text size="large" tag="b">允许租户修改流程节点监听器</el-text>
      </template>
      <div class="flex flex-col w-100%">
        <div class="flex">
          <el-switch
            v-model="modelData.allowUpdateNodeListener"
          />
        </div>
      </div>
    </el-form-item>
...
import { ProcessVariableEnum } from '@/components/SimpleProcessDesignerV2Tenant/src/consts'
import HttpRequestSettingTenant from '@/components/SimpleProcessDesignerV2Tenant/src/nodes-config/components/HttpRequestSettingTenant.vue'
