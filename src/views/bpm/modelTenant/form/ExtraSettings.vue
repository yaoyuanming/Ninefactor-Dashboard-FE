 ...
 * 是否允许修改流程基本信息
 */
const allowUpdateBasicInfo = ref(false)
const allowUpdateExtraSetting = ref(false)
const allowUpdateProcess = ref(false)
const allowUpdateNodeButtonsSetting = ref(false)
const allowUpdateNodeListener = ref(false)
