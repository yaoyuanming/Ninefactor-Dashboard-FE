var JSAudioInterComModule = (function () {
  ...
  return function (JSAudioInterComModule) {
    ...
    var asmLibraryArg = {
      ...
      f: _alListenerfv,
      q: _alSourcePlay,
      i: _alSourceQueueBuffers,
      h: _alSourceStop,
      e: _alSourceUnqueueBuffers,
      g: _alSourcef,
      l: _alSourcefv,
      u: _alSourcei,
      W: _alcCaptureCloseDevice,
      X: _alcCaptureOpenDevice,
      T: _alcCaptureSamples,
      V: _alcCaptureStart,
      U: _alcCaptureStop,
      ga: _alcCloseDevice,
      y: _alcCreateContext,
      fa: _alcDestroyContext,
      _: _alcGetContextsDevice,
      m: _alcGetCurrentContext,
      Y: _alcGetEnumValue,
      Z: _alcGetError,
      ba: _alcGetIntegerv,
      s: _alcGetString,
      da: _alcIsExtensionPresent,
      x: _alcMakeContextCurrent,
      r: _alcOpenDevice,
      aa: _alcProcessContext,
      $: _alcSuspendContext,
      N: _clock,
      S: _emscripten_alcDevicePauseSOFT,
      R: _emscripten_alcDeviceResumeSOFT,
      Q: _emscripten_alcGetStringiSOFT,
      P: _emscripten_alcResetDeviceSOFT,
      o: _emscripten_asm_const_int,
      la: _emscripten_memcpy_big,
      ma: _emscripten_resize_heap,
      M: _emscripten_thread_sleep,
      C: _fd_write,
      L: _gettimeofday,
      G: _setTempRet0,
    };
    ...
    var stackSave = (Module['stackSave'] = function () {
      return (stackSave = Module['stackSave'] = Module['asm']['nb']).apply(
        null,
        arguments
      );
    });
    ...
    var stackAlloc = (Module['stackAlloc'] = function () {
      return (stackAlloc = Module['stackAlloc'] = Module['asm']['pb']).apply(
        null,
        arguments
      );
    });
