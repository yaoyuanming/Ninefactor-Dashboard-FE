var JSPlayerModule = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var ASM_CONSTS = {
      715380: ($0) => {
        Module['firstGLContextExt'] =
          GL.contexts[$0].GLctx.getExtension('WEBGL_lose_context');
      },
      715472: () => {
        Module['firstGLContextExt'].loseContext();
      },
      715519: ($0, $1, $2, $3, $4, $5) => {
        JSPlayM4_CaptrueRGBDataCallBack($0, $1, $2, $3, $4, $5);
      },
      715575: ($0, $1, $2, $3, $4, $5, $6) => {
        JSPlayM4_FishCaptrueRGBDataCallBack($0, $1, $2, $3, $4, $5, $6);
      },
      715638: ($0, $1, $2) => {
        JSPlayM4_SetPlayPosSucCallBack($0, $1, $2);
      },
      715684: ($0, $1, $2) => {
        JSPlayM4_SetPlayPosSucCallBack($0, $1, $2);
      },
      715730: ($0, $1) => {
        JSPlayM4_FirstFrameCallBack($0, $1);
      },
      715770: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => {
        JSPlayM4_DecCallBack($0, $1, $2, $3, $4, $5, $6, $7, $8);
      },
      715824: ($0, $1, $2, $3, $4, $5, $6, $7, $8) => {
        JSPlayM4_DisplayCallBack($0, $1, $2, $3, $4, $5, $6, $7, $8);
      },
      715882: ($0, $1, $2) => {
        JSPlayM4_RawDataCallBack($0, 0, $1, $2);
      },
      715924: ($0, $1, $2, $3, $4) => {
        JSPlayM4_PrivateInfoCallBack($0, $1, $2, $3, $4);
      },
      715974: () => {
        return GROWABLE_HEAP_I8().length;
      },
      715994: ($0, $1, $2) => {
        JSPlayM4_AdditionDataCBFun($0, $1, $2);
      },
      716036: ($0, $1, $2, $3) => {
        JSPlayM4_RunTimeInfoCallBack($0, $1, $2, $3);
      },
      716083: ($0, $1, $2) => {
        JSPlayM4_StreamInfoCallBack($0, $1, $2);
      },
      716126: ($0, $1, $2) => {
        JSPlayM4_PostMpStreamOffsetCBFun($0, $1, $2);
      },
      716174: () => {
        return GROWABLE_HEAP_I8().length;
      },
      ...
      receiveObjectTransfer: function (data) {
        if (typeof GL != 'undefined') {
          ...
          if (
            !Module['canvas'] &&
            data.moduleCanvasId &&
            GL.offscreenCanvases[data.moduleCanvasId]
          ) {
            Module['canvas'] =
              GL.offscreenCanvases[data.moduleCanvasId].offscreenCanvas;
    ...
    function ___pthread_create_js(pthread_ptr, attr, startRoutine, arg) {
      ...
      var transferList = [];
      var error = 0;
      var transferredCanvasNames = attr
        ? GROWABLE_HEAP_U32()[(attr + 40) >> 2]
        : 0;
      if (transferredCanvasNames == -1 >>> 0)
        transferredCanvasNames = '#canvas';
      else if (transferredCanvasNames)
        transferredCanvasNames = UTF8ToString(transferredCanvasNames).trim();
      if (transferredCanvasNames)
      ...
      for (var i = 0; i < transferredCanvasNames.length; i++) {
        ...
        try {
          ...
          if (GL.offscreenCanvases[name]) {
            ...
            if (
              Module['canvas'] instanceof OffscreenCanvas &&
              name === Module['canvas'].id
            )
              Module['canvas'] = null;
          } else if (!ENVIRONMENT_IS_PTHREAD) {
            var canvas =
              Module['canvas'] && Module['canvas'].id === name
                ? Module['canvas']
            ...
            if (canvas.transferControlToOffscreen) {
              if (!canvas.canvasSharedPtr) {
                ...
                GROWABLE_HEAP_I32()[(canvas.canvasSharedPtr + 4) >> 2] =
                  canvas.height;
    ...
    function setOffscreenCanvasSizeOnTargetThread(
      targetThread,
      targetCanvas,
      width,
      height
    ...
    var GL = {
      ...
      createContext: function (canvas, webGLContextAttributes) {
        if (Module['preinitializedWebGLContext']) {
          ...
          webGLContextAttributes.majorVersion = Number(
            ctx.getParameter(ctx.VERSION).match(/^WebGL (\d+).\d+/)[1]
          );
        } else {
    ...
    function setCanvasElementSizeMainThread(target, width, height) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(7, 1, target, width, height);
    ...
    var __emscripten_set_offscreencanvas_size =
    ...
    function _alBufferData(bufferId, format, pData, size, freq) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(8, 1, bufferId, format, pData, size, freq);
      if (!AL.currentCtx) {
        return;
      }
      var buf = AL.buffers[bufferId];
    ...
    function _alDeleteBuffers(count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(9, 1, count, pBufferIds);
      if (!AL.currentCtx) {
        return;
      }
      for (var i = 0; i < count; ++i) {
    ...
    function _alSourcei(sourceId, param, value) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(11, 1, sourceId, param, value);
      switch (param) {
        case 514:
        case 4097:
        case 4098:
    ...
    function _alDeleteSources(count, pSourceIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(10, 1, count, pSourceIds);
      if (!AL.currentCtx) {
        return;
      }
      for (var i = 0; i < count; ++i) {
    ...
    function _alGenBuffers(count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(12, 1, count, pBufferIds);
      if (!AL.currentCtx) {
        return;
      }
      for (var i = 0; i < count; ++i) {
    ...
    function _alGenSources(count, pSourceIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(13, 1, count, pSourceIds);
      if (!AL.currentCtx) {
        return;
      }
      for (var i = 0; i < count; ++i) {
    ...
    function _alGetSourcef(sourceId, param, pValue) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(15, 1, sourceId, param, pValue);
    ...
    function _alGetSourcei(sourceId, param, pValue) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(16, 1, sourceId, param, pValue);
    ...
    function _alListenerfv(param, pValues) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(17, 1, param, pValues);
      if (!AL.currentCtx) {
        return;
      }
      if (!pValues) {
    ...
    function _alSourcePlay(sourceId) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(18, 1, sourceId);
      if (!AL.currentCtx) {
        return;
      }
      var src = AL.currentCtx.sources[sourceId];
    ...
    function _alSourceQueueBuffers(sourceId, count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(19, 1, sourceId, count, pBufferIds);
      if (!AL.currentCtx) {
        return;
      }
      var src = AL.currentCtx.sources[sourceId];
    ...
    function _alSourceStop(sourceId) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(20, 1, sourceId);
      if (!AL.currentCtx) {
        return;
      }
      var src = AL.currentCtx.sources[sourceId];
    ...
    function _alSourceUnqueueBuffers(sourceId, count, pBufferIds) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(21, 1, sourceId, count, pBufferIds);
      if (!AL.currentCtx) {
        return;
      }
      var src = AL.currentCtx.sources[sourceId];
    ...
    function _alSourcefv(sourceId, param, pValues) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(23, 1, sourceId, param, pValues);
      if (!AL.currentCtx) {
        return;
      }
      if (!pValues) {
    ...
    function _alcCreateContext(deviceId, pAttrList) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(24, 1, deviceId, pAttrList);
    ...
    function _alcGetString(deviceId, param) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(26, 1, deviceId, param);
    ...
    function _alcMakeContextCurrent(contextId) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(27, 1, contextId);
      if (contextId === 0) {
        AL.currentCtx = null;
      } else {
    ...
    function _alcOpenDevice(pDeviceName) {
      if (ENVIRONMENT_IS_PTHREAD) return proxyToMainThread(28, 1, pDeviceName);
      if (pDeviceName) {
    ...
    var readEmAsmArgs = (sigPtr, buf) => {
      ...
      while ((ch = GROWABLE_HEAP_U8()[sigPtr++])) {
        ...
        readEmAsmArgsArray.push(
          ch == 105 ? GROWABLE_HEAP_I32()[buf] : GROWABLE_HEAP_F64()[buf++ >> 1]
        );
        ++buf;
      }
    ...
    function getCanvasSizeMainThread(target, width, height) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(29, 1, target, width, height);
    ...
    var _emscripten_webgl_destroy_context_main_thread =
    ...
    function _environ_get(__environ, environ_buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(30, 1, __environ, environ_buf);
      var bufSize = 0;
    ...
    function _environ_sizes_get(penviron_count, penviron_buf_size) {
      if (ENVIRONMENT_IS_PTHREAD)
        return proxyToMainThread(31, 1, penviron_count, penviron_buf_size);
    ...
    var _DecCallBack = (Module['_DecCallBack'] = function () {
      return (_DecCallBack = Module['_DecCallBack'] =
        Module['asm']['DecCallBack']).apply(null, arguments);
    });
    var _DisplayCallBack = (Module['_DisplayCallBack'] = function () {
      return (_DisplayCallBack = Module['_DisplayCallBack'] =
        Module['asm']['DisplayCallBack']).apply(null, arguments);
    });
    var _RawDataCallBack = (Module['_RawDataCallBack'] = function () {
      return (_RawDataCallBack = Module['_RawDataCallBack'] =
        Module['asm']['RawDataCallBack']).apply(null, arguments);
    });
    var _FrameInfoCallBack = (Module['_FrameInfoCallBack'] = function () {
      return (_FrameInfoCallBack = Module['_FrameInfoCallBack'] =
        Module['asm']['FrameInfoCallBack']).apply(null, arguments);
    });
    var _PrivateInfoCBFun = (Module['_PrivateInfoCBFun'] = function () {
      return (_PrivateInfoCBFun = Module['_PrivateInfoCBFun'] =
        Module['asm']['PrivateInfoCBFun']).apply(null, arguments);
    });
    var _getTotalMemory = (Module['_getTotalMemory'] = function () {
      return (_getTotalMemory = Module['_getTotalMemory'] =
        Module['asm']['getTotalMemory']).apply(null, arguments);
    });
    var _getFreeMemory = (Module['_getFreeMemory'] = function () {
      return (_getFreeMemory = Module['_getFreeMemory'] =
        Module['asm']['getFreeMemory']).apply(null, arguments);
    });
    var _AdditionDataCBFun = (Module['_AdditionDataCBFun'] = function () {
      return (_AdditionDataCBFun = Module['_AdditionDataCBFun'] =
        Module['asm']['AdditionDataCBFun']).apply(null, arguments);
    });
    var _RunTimeInfoCBFun = (Module['_RunTimeInfoCBFun'] = function () {
      return (_RunTimeInfoCBFun = Module['_RunTimeInfoCBFun'] =
        Module['asm']['RunTimeInfoCBFun']).apply(null, arguments);
    });
    var _StreamInfoCBFun = (Module['_StreamInfoCBFun'] = function () {
      return (_StreamInfoCBFun = Module['_StreamInfoCBFun'] =
        Module['asm']['StreamInfoCBFun']).apply(null, arguments);
    });
    var _PostMpStreamOffsetCBFun = (Module['_PostMpStreamOffsetCBFun'] =
      function () {
        return (_PostMpStreamOffsetCBFun = Module['_PostMpStreamOffsetCBFun'] =
          Module['asm']['PostMpStreamOffsetCBFun']).apply(null, arguments);
      });
    var _JSPlayM4_GetFrameInfo = (Module['_JSPlayM4_GetFrameInfo'] =
      function () {
        return (_JSPlayM4_GetFrameInfo = Module['_JSPlayM4_GetFrameInfo'] =
          Module['asm']['JSPlayM4_GetFrameInfo']).apply(null, arguments);
      });
    var _JSPlayM4_GetPort = (Module['_JSPlayM4_GetPort'] = function () {
      return (_JSPlayM4_GetPort = Module['_JSPlayM4_GetPort'] =
        Module['asm']['JSPlayM4_GetPort']).apply(null, arguments);
    });
    var _JSPlayM4_SetStreamOpenMode = (Module['_JSPlayM4_SetStreamOpenMode'] =
      function () {
        return (_JSPlayM4_SetStreamOpenMode = Module[
          '_JSPlayM4_SetStreamOpenMode'
        ] =
          Module['asm']['JSPlayM4_SetStreamOpenMode']).apply(null, arguments);
      });
    var _JSPlayM4_OpenStream = (Module['_JSPlayM4_OpenStream'] = function () {
      return (_JSPlayM4_OpenStream = Module['_JSPlayM4_OpenStream'] =
        Module['asm']['JSPlayM4_OpenStream']).apply(null, arguments);
    });
    var _JSPlayM4_OpenStreamAdvanced = (Module['_JSPlayM4_OpenStreamAdvanced'] =
      function () {
        return (_JSPlayM4_OpenStreamAdvanced = Module[
          '_JSPlayM4_OpenStreamAdvanced'
        ] =
          Module['asm']['JSPlayM4_OpenStreamAdvanced']).apply(null, arguments);
      });
    var _JSPlayM4_SetFirstFrameCallBack = (Module[
      '_JSPlayM4_SetFirstFrameCallBack'
    ] = function () {
      return (_JSPlayM4_SetFirstFrameCallBack = Module[
        '_JSPlayM4_SetFirstFrameCallBack'
      ] =
        Module['asm']['JSPlayM4_SetFirstFrameCallBack']).apply(null, arguments);
    });
    var _JSPlayM4_SetDecOrDisplayCallbackType = (Module[
      '_JSPlayM4_SetDecOrDisplayCallbackType'
    ] = function () {
      return (_JSPlayM4_SetDecOrDisplayCallbackType = Module[
        '_JSPlayM4_SetDecOrDisplayCallbackType'
      ] =
        Module['asm']['JSPlayM4_SetDecOrDisplayCallbackType']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetDecCallBack = (Module['_JSPlayM4_SetDecCallBack'] =
      function () {
        return (_JSPlayM4_SetDecCallBack = Module['_JSPlayM4_SetDecCallBack'] =
          Module['asm']['JSPlayM4_SetDecCallBack']).apply(null, arguments);
      });
    var _JSPlayM4_SetDisplayCallBack = (Module['_JSPlayM4_SetDisplayCallBack'] =
      function () {
        return (_JSPlayM4_SetDisplayCallBack = Module[
          '_JSPlayM4_SetDisplayCallBack'
        ] =
          Module['asm']['JSPlayM4_SetDisplayCallBack']).apply(null, arguments);
      });
    var _JSPlayM4_SetFrameInfoCallBack = (Module[
      '_JSPlayM4_SetFrameInfoCallBack'
    ] = function () {
      return (_JSPlayM4_SetFrameInfoCallBack = Module[
        '_JSPlayM4_SetFrameInfoCallBack'
      ] =
        Module['asm']['JSPlayM4_SetFrameInfoCallBack']).apply(null, arguments);
    });
    var _JSPlayM4_SetResetCallBack = (Module['_JSPlayM4_SetResetCallBack'] =
      function () {
        return (_JSPlayM4_SetResetCallBack = Module[
          '_JSPlayM4_SetResetCallBack'
        ] =
          Module['asm']['JSPlayM4_SetResetCallBack']).apply(null, arguments);
      });
    var _JSPlayM4_SetVideoRawDataCallBack0 = (Module[
      '_JSPlayM4_SetVideoRawDataCallBack0'
    ] = function () {
      return (_JSPlayM4_SetVideoRawDataCallBack0 = Module[
        '_JSPlayM4_SetVideoRawDataCallBack0'
      ] =
        Module['asm']['JSPlayM4_SetVideoRawDataCallBack0']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetVideoRawDataCallBack = (Module[
      '_JSPlayM4_SetVideoRawDataCallBack'
    ] = function () {
      return (_JSPlayM4_SetVideoRawDataCallBack = Module[
        '_JSPlayM4_SetVideoRawDataCallBack'
      ] =
        Module['asm']['JSPlayM4_SetVideoRawDataCallBack']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetDecCBStream = (Module['_JSPlayM4_SetDecCBStream'] =
      function () {
        return (_JSPlayM4_SetDecCBStream = Module['_JSPlayM4_SetDecCBStream'] =
          Module['asm']['JSPlayM4_SetDecCBStream']).apply(null, arguments);
      });
    var _JSPlayM4_Play = (Module['_JSPlayM4_Play'] = function () {
      return (_JSPlayM4_Play = Module['_JSPlayM4_Play'] =
        Module['asm']['JSPlayM4_Play']).apply(null, arguments);
    });
    var _JSPlayM4_InputData = (Module['_JSPlayM4_InputData'] = function () {
      return (_JSPlayM4_InputData = Module['_JSPlayM4_InputData'] =
        Module['asm']['JSPlayM4_InputData']).apply(null, arguments);
    });
    var _JSPlayM4_Stop = (Module['_JSPlayM4_Stop'] = function () {
      return (_JSPlayM4_Stop = Module['_JSPlayM4_Stop'] =
        Module['asm']['JSPlayM4_Stop']).apply(null, arguments);
    });
    var _JSPlayM4_CloseStream = (Module['_JSPlayM4_CloseStream'] = function () {
      return (_JSPlayM4_CloseStream = Module['_JSPlayM4_CloseStream'] =
        Module['asm']['JSPlayM4_CloseStream']).apply(null, arguments);
    });
    var _JSPlayM4_FreePort = (Module['_JSPlayM4_FreePort'] = function () {
      return (_JSPlayM4_FreePort = Module['_JSPlayM4_FreePort'] =
        Module['asm']['JSPlayM4_FreePort']).apply(null, arguments);
    });
    var _JSPlayM4_SetDecodeFrameType = (Module['_JSPlayM4_SetDecodeFrameType'] =
      function () {
        return (_JSPlayM4_SetDecodeFrameType = Module[
          '_JSPlayM4_SetDecodeFrameType'
        ] =
          Module['asm']['JSPlayM4_SetDecodeFrameType']).apply(null, arguments);
      });
    var _JSPlayM4_PlaySound = (Module['_JSPlayM4_PlaySound'] = function () {
      return (_JSPlayM4_PlaySound = Module['_JSPlayM4_PlaySound'] =
        Module['asm']['JSPlayM4_PlaySound']).apply(null, arguments);
    });
    var _JSPlayM4_PlaySoundShare = (Module['_JSPlayM4_PlaySoundShare'] =
      function () {
        return (_JSPlayM4_PlaySoundShare = Module['_JSPlayM4_PlaySoundShare'] =
          Module['asm']['JSPlayM4_PlaySoundShare']).apply(null, arguments);
      });
    var _JSPlayM4_StopSoundShare = (Module['_JSPlayM4_StopSoundShare'] =
      function () {
        return (_JSPlayM4_StopSoundShare = Module['_JSPlayM4_StopSoundShare'] =
          Module['asm']['JSPlayM4_StopSoundShare']).apply(null, arguments);
      });
    var _JSPlayM4_SetRecoderAudio = (Module['_JSPlayM4_SetRecoderAudio'] =
      function () {
        return (_JSPlayM4_SetRecoderAudio = Module[
          '_JSPlayM4_SetRecoderAudio'
        ] =
          Module['asm']['JSPlayM4_SetRecoderAudio']).apply(null, arguments);
      });
    var _JSPlayM4_SetSecretKey = (Module['_JSPlayM4_SetSecretKey'] =
      function () {
        return (_JSPlayM4_SetSecretKey = Module['_JSPlayM4_SetSecretKey'] =
          Module['asm']['JSPlayM4_SetSecretKey']).apply(null, arguments);
      });
    var _JSPlayM4_GetJPEG = (Module['_JSPlayM4_GetJPEG'] = function () {
      return (_JSPlayM4_GetJPEG = Module['_JSPlayM4_GetJPEG'] =
        Module['asm']['JSPlayM4_GetJPEG']).apply(null, arguments);
    });
    var _JSPlayM4_GetBMP = (Module['_JSPlayM4_GetBMP'] = function () {
      return (_JSPlayM4_GetBMP = Module['_JSPlayM4_GetBMP'] =
        Module['asm']['JSPlayM4_GetBMP']).apply(null, arguments);
    });
    var _JSPlayM4_GetCropJPEG = (Module['_JSPlayM4_GetCropJPEG'] = function () {
      return (_JSPlayM4_GetCropJPEG = Module['_JSPlayM4_GetCropJPEG'] =
        Module['asm']['JSPlayM4_GetCropJPEG']).apply(null, arguments);
    });
    var _JSPlayM4_GetCropBMP = (Module['_JSPlayM4_GetCropBMP'] = function () {
      return (_JSPlayM4_GetCropBMP = Module['_JSPlayM4_GetCropBMP'] =
        Module['asm']['JSPlayM4_GetCropBMP']).apply(null, arguments);
    });
    var _JSPlayM4_StopSound = (Module['_JSPlayM4_StopSound'] = function () {
      return (_JSPlayM4_StopSound = Module['_JSPlayM4_StopSound'] =
        Module['asm']['JSPlayM4_StopSound']).apply(null, arguments);
    });
    var _JSPlayM4_GetSDKVersion = (Module['_JSPlayM4_GetSDKVersion'] =
      function () {
        return (_JSPlayM4_GetSDKVersion = Module['_JSPlayM4_GetSDKVersion'] =
          Module['asm']['JSPlayM4_GetSDKVersion']).apply(null, arguments);
      });
    var _JSPlayM4_GetBuildDate = (Module['_JSPlayM4_GetBuildDate'] =
      function () {
        return (_JSPlayM4_GetBuildDate = Module['_JSPlayM4_GetBuildDate'] =
          Module['asm']['JSPlayM4_GetBuildDate']).apply(null, arguments);
      });
    var _JSPlayM4_GetLastError = (Module['_JSPlayM4_GetLastError'] =
      function () {
        return (_JSPlayM4_GetLastError = Module['_JSPlayM4_GetLastError'] =
          Module['asm']['JSPlayM4_GetLastError']).apply(null, arguments);
      });
    var _JSPlayM4_Fast = (Module['_JSPlayM4_Fast'] = function () {
      return (_JSPlayM4_Fast = Module['_JSPlayM4_Fast'] =
        Module['asm']['JSPlayM4_Fast']).apply(null, arguments);
    });
    var _JSPlayM4_Slow = (Module['_JSPlayM4_Slow'] = function () {
      return (_JSPlayM4_Slow = Module['_JSPlayM4_Slow'] =
        Module['asm']['JSPlayM4_Slow']).apply(null, arguments);
    });
    var _JSPlayM4_SetIFrameDecInterval = (Module[
      '_JSPlayM4_SetIFrameDecInterval'
    ] = function () {
      return (_JSPlayM4_SetIFrameDecInterval = Module[
        '_JSPlayM4_SetIFrameDecInterval'
      ] =
        Module['asm']['JSPlayM4_SetIFrameDecInterval']).apply(null, arguments);
    });
    var _JSPlayM4_SetDecodeThread = (Module['_JSPlayM4_SetDecodeThread'] =
      function () {
        return (_JSPlayM4_SetDecodeThread = Module[
          '_JSPlayM4_SetDecodeThread'
        ] =
          Module['asm']['JSPlayM4_SetDecodeThread']).apply(null, arguments);
      });
    var _JSPlayM4_Pause = (Module['_JSPlayM4_Pause'] = function () {
      return (_JSPlayM4_Pause = Module['_JSPlayM4_Pause'] =
        Module['asm']['JSPlayM4_Pause']).apply(null, arguments);
    });
    var _JSPlayM4_OneByOne = (Module['_JSPlayM4_OneByOne'] = function () {
      return (_JSPlayM4_OneByOne = Module['_JSPlayM4_OneByOne'] =
        Module['asm']['JSPlayM4_OneByOne']).apply(null, arguments);
    });
    var _JSPlayM4_SetVolume = (Module['_JSPlayM4_SetVolume'] = function () {
      return (_JSPlayM4_SetVolume = Module['_JSPlayM4_SetVolume'] =
        Module['asm']['JSPlayM4_SetVolume']).apply(null, arguments);
    });
    var _JSPlayM4_GetVolume = (Module['_JSPlayM4_GetVolume'] = function () {
      return (_JSPlayM4_GetVolume = Module['_JSPlayM4_GetVolume'] =
        Module['asm']['JSPlayM4_GetVolume']).apply(null, arguments);
    });
    var _JSPlayM4_SetDisplayRegion = (Module['_JSPlayM4_SetDisplayRegion'] =
      function () {
        return (_JSPlayM4_SetDisplayRegion = Module[
          '_JSPlayM4_SetDisplayRegion'
        ] =
          Module['asm']['JSPlayM4_SetDisplayRegion']).apply(null, arguments);
      });
    var _JSPlayM4_SetPrintLogFlag = (Module['_JSPlayM4_SetPrintLogFlag'] =
      function () {
        return (_JSPlayM4_SetPrintLogFlag = Module[
          '_JSPlayM4_SetPrintLogFlag'
        ] =
          Module['asm']['JSPlayM4_SetPrintLogFlag']).apply(null, arguments);
      });
    var _JSPlayM4_RenderPrivateData = (Module['_JSPlayM4_RenderPrivateData'] =
      function () {
        return (_JSPlayM4_RenderPrivateData = Module[
          '_JSPlayM4_RenderPrivateData'
        ] =
          Module['asm']['JSPlayM4_RenderPrivateData']).apply(null, arguments);
      });
    var _JSPlayM4_RenderPrivateDataEx = (Module[
      '_JSPlayM4_RenderPrivateDataEx'
    ] = function () {
      return (_JSPlayM4_RenderPrivateDataEx = Module[
        '_JSPlayM4_RenderPrivateDataEx'
      ] =
        Module['asm']['JSPlayM4_RenderPrivateDataEx']).apply(null, arguments);
    });
    var _JSPlayM4_SetCanvasSize = (Module['_JSPlayM4_SetCanvasSize'] =
      function () {
        return (_JSPlayM4_SetCanvasSize = Module['_JSPlayM4_SetCanvasSize'] =
          Module['asm']['JSPlayM4_SetCanvasSize']).apply(null, arguments);
      });
    var _JSPlayM4_SetDisplayBuf = (Module['_JSPlayM4_SetDisplayBuf'] =
      function () {
        return (_JSPlayM4_SetDisplayBuf = Module['_JSPlayM4_SetDisplayBuf'] =
          Module['asm']['JSPlayM4_SetDisplayBuf']).apply(null, arguments);
      });
    var _JSPlayM4_SetAudioDisplayBuf = (Module['_JSPlayM4_SetAudioDisplayBuf'] =
      function () {
        return (_JSPlayM4_SetAudioDisplayBuf = Module[
          '_JSPlayM4_SetAudioDisplayBuf'
        ] =
          Module['asm']['JSPlayM4_SetAudioDisplayBuf']).apply(null, arguments);
      });
    var _JSPlayM4_GetSourceBufferRemain = (Module[
      '_JSPlayM4_GetSourceBufferRemain'
    ] = function () {
      return (_JSPlayM4_GetSourceBufferRemain = Module[
        '_JSPlayM4_GetSourceBufferRemain'
      ] =
        Module['asm']['JSPlayM4_GetSourceBufferRemain']).apply(null, arguments);
    });
    var _JSPlayM4_GetBufferValue = (Module['_JSPlayM4_GetBufferValue'] =
      function () {
        return (_JSPlayM4_GetBufferValue = Module['_JSPlayM4_GetBufferValue'] =
          Module['asm']['JSPlayM4_GetBufferValue']).apply(null, arguments);
      });
    var _JSPlayM4_ReversePlay = (Module['_JSPlayM4_ReversePlay'] = function () {
      return (_JSPlayM4_ReversePlay = Module['_JSPlayM4_ReversePlay'] =
        Module['asm']['JSPlayM4_ReversePlay']).apply(null, arguments);
    });
    var _JSPlayM4_SetDecodeThreadNum = (Module['_JSPlayM4_SetDecodeThreadNum'] =
      function () {
        return (_JSPlayM4_SetDecodeThreadNum = Module[
          '_JSPlayM4_SetDecodeThreadNum'
        ] =
          Module['asm']['JSPlayM4_SetDecodeThreadNum']).apply(null, arguments);
      });
    var _JSPlayM4_GetCanvasSize = (Module['_JSPlayM4_GetCanvasSize'] =
      function () {
        return (_JSPlayM4_GetCanvasSize = Module['_JSPlayM4_GetCanvasSize'] =
          Module['asm']['JSPlayM4_GetCanvasSize']).apply(null, arguments);
      });
    var _JSPlayM4_DisplayLostFrames = (Module['_JSPlayM4_DisplayLostFrames'] =
      function () {
        return (_JSPlayM4_DisplayLostFrames = Module[
          '_JSPlayM4_DisplayLostFrames'
        ] =
          Module['asm']['JSPlayM4_DisplayLostFrames']).apply(null, arguments);
      });
    var _JSPlayM4_SetANRParam = (Module['_JSPlayM4_SetANRParam'] = function () {
      return (_JSPlayM4_SetANRParam = Module['_JSPlayM4_SetANRParam'] =
        Module['asm']['JSPlayM4_SetANRParam']).apply(null, arguments);
    });
    var _JSPlayM4_SetResampleValue = (Module['_JSPlayM4_SetResampleValue'] =
      function () {
        return (_JSPlayM4_SetResampleValue = Module[
          '_JSPlayM4_SetResampleValue'
        ] =
          Module['asm']['JSPlayM4_SetResampleValue']).apply(null, arguments);
      });
    var _JSPlayM4_SetAntialias = (Module['_JSPlayM4_SetAntialias'] =
      function () {
        return (_JSPlayM4_SetAntialias = Module['_JSPlayM4_SetAntialias'] =
          Module['asm']['JSPlayM4_SetAntialias']).apply(null, arguments);
      });
    var _JSPlayM4_SyncToAudio = (Module['_JSPlayM4_SyncToAudio'] = function () {
      return (_JSPlayM4_SyncToAudio = Module['_JSPlayM4_SyncToAudio'] =
        Module['asm']['JSPlayM4_SyncToAudio']).apply(null, arguments);
    });
    var _JSPlayM4_SetAudioThreadModel = (Module[
      '_JSPlayM4_SetAudioThreadModel'
    ] = function () {
      return (_JSPlayM4_SetAudioThreadModel = Module[
        '_JSPlayM4_SetAudioThreadModel'
      ] =
        Module['asm']['JSPlayM4_SetAudioThreadModel']).apply(null, arguments);
    });
    var _JSPlayM4_SetDecodeERC = (Module['_JSPlayM4_SetDecodeERC'] =
      function () {
        return (_JSPlayM4_SetDecodeERC = Module['_JSPlayM4_SetDecodeERC'] =
          Module['asm']['JSPlayM4_SetDecodeERC']).apply(null, arguments);
      });
    var _JSPlayM4_SkipErrorData = (Module['_JSPlayM4_SkipErrorData'] =
      function () {
        return (_JSPlayM4_SkipErrorData = Module['_JSPlayM4_SkipErrorData'] =
          Module['asm']['JSPlayM4_SkipErrorData']).apply(null, arguments);
      });
    var _JSPlayM4_SetAdditionDataCallBack = (Module[
      '_JSPlayM4_SetAdditionDataCallBack'
    ] = function () {
      return (_JSPlayM4_SetAdditionDataCallBack = Module[
        '_JSPlayM4_SetAdditionDataCallBack'
      ] =
        Module['asm']['JSPlayM4_SetAdditionDataCallBack']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_GetAdditionData = (Module['_JSPlayM4_GetAdditionData'] =
      function () {
        return (_JSPlayM4_GetAdditionData = Module[
          '_JSPlayM4_GetAdditionData'
        ] =
          Module['asm']['JSPlayM4_GetAdditionData']).apply(null, arguments);
      });
    var _JSPlayM4_SetDemuxModel = (Module['_JSPlayM4_SetDemuxModel'] =
      function () {
        return (_JSPlayM4_SetDemuxModel = Module['_JSPlayM4_SetDemuxModel'] =
          Module['asm']['JSPlayM4_SetDemuxModel']).apply(null, arguments);
      });
    var _JSPlayM4_SetD3DPostProcess = (Module['_JSPlayM4_SetD3DPostProcess'] =
      function () {
        return (_JSPlayM4_SetD3DPostProcess = Module[
          '_JSPlayM4_SetD3DPostProcess'
        ] =
          Module['asm']['JSPlayM4_SetD3DPostProcess']).apply(null, arguments);
      });
    var _JSPlayM4_SetDecodeEngine = (Module['_JSPlayM4_SetDecodeEngine'] =
      function () {
        return (_JSPlayM4_SetDecodeEngine = Module[
          '_JSPlayM4_SetDecodeEngine'
        ] =
          Module['asm']['JSPlayM4_SetDecodeEngine']).apply(null, arguments);
      });
    var _JSPlayM4_SetGlobalBaseTime = (Module['_JSPlayM4_SetGlobalBaseTime'] =
      function () {
        return (_JSPlayM4_SetGlobalBaseTime = Module[
          '_JSPlayM4_SetGlobalBaseTime'
        ] =
          Module['asm']['JSPlayM4_SetGlobalBaseTime']).apply(null, arguments);
      });
    var _JSPlayM4_GetPlayedTimeEx = (Module['_JSPlayM4_GetPlayedTimeEx'] =
      function () {
        return (_JSPlayM4_GetPlayedTimeEx = Module[
          '_JSPlayM4_GetPlayedTimeEx'
        ] =
          Module['asm']['JSPlayM4_GetPlayedTimeEx']).apply(null, arguments);
      });
    ...
    var _JSPlayM4_GetMpOffset = (Module['_JSPlayM4_GetMpOffset'] = function () {
      return (_JSPlayM4_GetMpOffset = Module['_JSPlayM4_GetMpOffset'] =
        Module['asm']['JSPlayM4_GetMpOffset']).apply(null, arguments);
    });
    var _JSPlayM4_ResetBuffer = (Module['_JSPlayM4_ResetBuffer'] = function () {
      return (_JSPlayM4_ResetBuffer = Module['_JSPlayM4_ResetBuffer'] =
        Module['asm']['JSPlayM4_ResetBuffer']).apply(null, arguments);
    });
    var _JSPlayM4_ResetEnd = (Module['_JSPlayM4_ResetEnd'] = function () {
      return (_JSPlayM4_ResetEnd = Module['_JSPlayM4_ResetEnd'] =
        Module['asm']['JSPlayM4_ResetEnd']).apply(null, arguments);
    });
    var _JSPlayM4_IgnoreHeaderAudioDefine = (Module[
      '_JSPlayM4_IgnoreHeaderAudioDefine'
    ] = function () {
      return (_JSPlayM4_IgnoreHeaderAudioDefine = Module[
        '_JSPlayM4_IgnoreHeaderAudioDefine'
      ] =
        Module['asm']['JSPlayM4_IgnoreHeaderAudioDefine']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetSycGroup = (Module['_JSPlayM4_SetSycGroup'] = function () {
      return (_JSPlayM4_SetSycGroup = Module['_JSPlayM4_SetSycGroup'] =
        Module['asm']['JSPlayM4_SetSycGroup']).apply(null, arguments);
    });
    var _JSPlayM4_SetSmartFirstKeyFrameDisplay = (Module[
      '_JSPlayM4_SetSmartFirstKeyFrameDisplay'
    ] = function () {
      return (_JSPlayM4_SetSmartFirstKeyFrameDisplay = Module[
        '_JSPlayM4_SetSmartFirstKeyFrameDisplay'
      ] =
        Module['asm']['JSPlayM4_SetSmartFirstKeyFrameDisplay']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_GetRawData = (Module['_JSPlayM4_GetRawData'] = function () {
      return (_JSPlayM4_GetRawData = Module['_JSPlayM4_GetRawData'] =
        Module['asm']['JSPlayM4_GetRawData']).apply(null, arguments);
    });
    var _JSPlayM4_VideoDataToBMP = (Module['_JSPlayM4_VideoDataToBMP'] =
      function () {
        return (_JSPlayM4_VideoDataToBMP = Module['_JSPlayM4_VideoDataToBMP'] =
          Module['asm']['JSPlayM4_VideoDataToBMP']).apply(null, arguments);
      });
    var _JSPlayM4_VideoDataToJpeg = (Module['_JSPlayM4_VideoDataToJpeg'] =
      function () {
        return (_JSPlayM4_VideoDataToJpeg = Module[
          '_JSPlayM4_VideoDataToJpeg'
        ] =
          Module['asm']['JSPlayM4_VideoDataToJpeg']).apply(null, arguments);
      });
    var _JSPlayM4_SetRunTimeInfoCallBackEx = (Module[
      '_JSPlayM4_SetRunTimeInfoCallBackEx'
    ] = function () {
      return (_JSPlayM4_SetRunTimeInfoCallBackEx = Module[
        '_JSPlayM4_SetRunTimeInfoCallBackEx'
      ] =
        Module['asm']['JSPlayM4_SetRunTimeInfoCallBackEx']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetRunTimeInfoCallbackType = (Module[
      '_JSPlayM4_SetRunTimeInfoCallbackType'
    ] = function () {
      return (_JSPlayM4_SetRunTimeInfoCallbackType = Module[
        '_JSPlayM4_SetRunTimeInfoCallbackType'
      ] =
        Module['asm']['JSPlayM4_SetRunTimeInfoCallbackType']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetStreamInfoCallBack = (Module[
      '_JSPlayM4_SetStreamInfoCallBack'
    ] = function () {
      return (_JSPlayM4_SetStreamInfoCallBack = Module[
        '_JSPlayM4_SetStreamInfoCallBack'
      ] =
        Module['asm']['JSPlayM4_SetStreamInfoCallBack']).apply(null, arguments);
    });
    var _JSPlayM4_SetPostMpStreamOffsetCallBack = (Module[
      '_JSPlayM4_SetPostMpStreamOffsetCallBack'
    ] = function () {
      return (_JSPlayM4_SetPostMpStreamOffsetCallBack = Module[
        '_JSPlayM4_SetPostMpStreamOffsetCallBack'
      ] =
        Module['asm']['JSPlayM4_SetPostMpStreamOffsetCallBack']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetPlayOrBackSwitchMode = (Module[
      '_JSPlayM4_SetPlayOrBackSwitchMode'
    ] = function () {
      return (_JSPlayM4_SetPlayOrBackSwitchMode = Module[
        '_JSPlayM4_SetPlayOrBackSwitchMode'
      ] =
        Module['asm']['JSPlayM4_SetPlayOrBackSwitchMode']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetStretchPlay = (Module['_JSPlayM4_SetStretchPlay'] =
      function () {
        return (_JSPlayM4_SetStretchPlay = Module['_JSPlayM4_SetStretchPlay'] =
          Module['asm']['JSPlayM4_SetStretchPlay']).apply(null, arguments);
      });
    var _JSPlayM4_SetAutoSmoothPlay = (Module['_JSPlayM4_SetAutoSmoothPlay'] =
      function () {
        return (_JSPlayM4_SetAutoSmoothPlay = Module[
          '_JSPlayM4_SetAutoSmoothPlay'
        ] =
          Module['asm']['JSPlayM4_SetAutoSmoothPlay']).apply(null, arguments);
      });
    var _JSPlayM4_KeepPlaySpeed = (Module['_JSPlayM4_KeepPlaySpeed'] =
      function () {
        return (_JSPlayM4_KeepPlaySpeed = Module['_JSPlayM4_KeepPlaySpeed'] =
          Module['asm']['JSPlayM4_KeepPlaySpeed']).apply(null, arguments);
      });
    var _JSPlayM4_SetPrivateInfoCallBack = (Module[
      '_JSPlayM4_SetPrivateInfoCallBack'
    ] = function () {
      return (_JSPlayM4_SetPrivateInfoCallBack = Module[
        '_JSPlayM4_SetPrivateInfoCallBack'
      ] =
        Module['asm']['JSPlayM4_SetPrivateInfoCallBack']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetRotateAngle = (Module['_JSPlayM4_SetRotateAngle'] =
      function () {
        return (_JSPlayM4_SetRotateAngle = Module['_JSPlayM4_SetRotateAngle'] =
          Module['asm']['JSPlayM4_SetRotateAngle']).apply(null, arguments);
      });
    var _JSPlayM4_SetHardQueueSize = (Module['_JSPlayM4_SetHardQueueSize'] =
      function () {
        return (_JSPlayM4_SetHardQueueSize = Module[
          '_JSPlayM4_SetHardQueueSize'
        ] =
          Module['asm']['JSPlayM4_SetHardQueueSize']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_GetPort = (Module['_JSPlayM4_FEC_GetPort'] = function () {
      return (_JSPlayM4_FEC_GetPort = Module['_JSPlayM4_FEC_GetPort'] =
        Module['asm']['JSPlayM4_FEC_GetPort']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_Enable = (Module['_JSPlayM4_FEC_Enable'] = function () {
      return (_JSPlayM4_FEC_Enable = Module['_JSPlayM4_FEC_Enable'] =
        Module['asm']['JSPlayM4_FEC_Enable']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_SetParam = (Module['_JSPlayM4_FEC_SetParam'] =
      function () {
        return (_JSPlayM4_FEC_SetParam = Module['_JSPlayM4_FEC_SetParam'] =
          Module['asm']['JSPlayM4_FEC_SetParam']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_SetViewParam = (Module['_JSPlayM4_FEC_SetViewParam'] =
      function () {
        return (_JSPlayM4_FEC_SetViewParam = Module[
          '_JSPlayM4_FEC_SetViewParam'
        ] =
          Module['asm']['JSPlayM4_FEC_SetViewParam']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_SetWnd = (Module['_JSPlayM4_FEC_SetWnd'] = function () {
      return (_JSPlayM4_FEC_SetWnd = Module['_JSPlayM4_FEC_SetWnd'] =
        Module['asm']['JSPlayM4_FEC_SetWnd']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_DelPort = (Module['_JSPlayM4_FEC_DelPort'] = function () {
      return (_JSPlayM4_FEC_DelPort = Module['_JSPlayM4_FEC_DelPort'] =
        Module['asm']['JSPlayM4_FEC_DelPort']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_Disable = (Module['_JSPlayM4_FEC_Disable'] = function () {
      return (_JSPlayM4_FEC_Disable = Module['_JSPlayM4_FEC_Disable'] =
        Module['asm']['JSPlayM4_FEC_Disable']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_ResetCorrectType = (Module[
      '_JSPlayM4_FEC_ResetCorrectType'
    ] = function () {
      return (_JSPlayM4_FEC_ResetCorrectType = Module[
        '_JSPlayM4_FEC_ResetCorrectType'
      ] =
        Module['asm']['JSPlayM4_FEC_ResetCorrectType']).apply(null, arguments);
    });
    var _JSPlayM4_FEC_SetDisplayRegion = (Module[
      '_JSPlayM4_FEC_SetDisplayRegion'
    ] = function () {
      return (_JSPlayM4_FEC_SetDisplayRegion = Module[
        '_JSPlayM4_FEC_SetDisplayRegion'
      ] =
        Module['asm']['JSPlayM4_FEC_SetDisplayRegion']).apply(null, arguments);
    });
    var _JSPlayM4_GetFishEye2DParam = (Module['_JSPlayM4_GetFishEye2DParam'] =
      function () {
        return (_JSPlayM4_GetFishEye2DParam = Module[
          '_JSPlayM4_GetFishEye2DParam'
        ] =
          Module['asm']['JSPlayM4_GetFishEye2DParam']).apply(null, arguments);
      });
    var _JSPlayM4_GetFishEyeViewParam = (Module[
      '_JSPlayM4_GetFishEyeViewParam'
    ] = function () {
      return (_JSPlayM4_GetFishEyeViewParam = Module[
        '_JSPlayM4_GetFishEyeViewParam'
      ] =
        Module['asm']['JSPlayM4_GetFishEyeViewParam']).apply(null, arguments);
    });
    var _JSPlayM4_GetViewParam = (Module['_JSPlayM4_GetViewParam'] =
      function () {
        return (_JSPlayM4_GetViewParam = Module['_JSPlayM4_GetViewParam'] =
          Module['asm']['JSPlayM4_GetViewParam']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_SetCanvasID = (Module['_JSPlayM4_FEC_SetCanvasID'] =
      function () {
        return (_JSPlayM4_FEC_SetCanvasID = Module[
          '_JSPlayM4_FEC_SetCanvasID'
        ] =
          Module['asm']['JSPlayM4_FEC_SetCanvasID']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_SetBackCilling = (Module['_JSPlayM4_FEC_SetBackCilling'] =
      function () {
        return (_JSPlayM4_FEC_SetBackCilling = Module[
          '_JSPlayM4_FEC_SetBackCilling'
        ] =
          Module['asm']['JSPlayM4_FEC_SetBackCilling']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_GetPTZPort = (Module['_JSPlayM4_FEC_GetPTZPort'] =
      function () {
        return (_JSPlayM4_FEC_GetPTZPort = Module['_JSPlayM4_FEC_GetPTZPort'] =
          Module['asm']['JSPlayM4_FEC_GetPTZPort']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_GetParam = (Module['_JSPlayM4_FEC_GetParam'] =
      function () {
        return (_JSPlayM4_FEC_GetParam = Module['_JSPlayM4_FEC_GetParam'] =
          Module['asm']['JSPlayM4_FEC_GetParam']).apply(null, arguments);
      });
    var _JSPlayM4_FEC_Capture = (Module['_JSPlayM4_FEC_Capture'] = function () {
      return (_JSPlayM4_FEC_Capture = Module['_JSPlayM4_FEC_Capture'] =
        Module['asm']['JSPlayM4_FEC_Capture']).apply(null, arguments);
    });
    var _JSPlayM4_GetWaterMarkFontStruct = (Module[
      '_JSPlayM4_GetWaterMarkFontStruct'
    ] = function () {
      return (_JSPlayM4_GetWaterMarkFontStruct = Module[
        '_JSPlayM4_GetWaterMarkFontStruct'
      ] =
        Module['asm']['JSPlayM4_GetWaterMarkFontStruct']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetWaterMarkFontString = (Module[
      '_JSPlayM4_SetWaterMarkFontString'
    ] = function () {
      return (_JSPlayM4_SetWaterMarkFontString = Module[
        '_JSPlayM4_SetWaterMarkFontString'
      ] =
        Module['asm']['JSPlayM4_SetWaterMarkFontString']).apply(
        null,
        arguments
      );
    });
    var _JSPlayM4_SetWaterMarkFont = (Module['_JSPlayM4_SetWaterMarkFont'] =
      function () {
        return (_JSPlayM4_SetWaterMarkFont = Module[
          '_JSPlayM4_SetWaterMarkFont'
        ] =
          Module['asm']['JSPlayM4_SetWaterMarkFont']).apply(null, arguments);
      });
    var _JSPlayM4_GetD3DCapture = (Module['_JSPlayM4_GetD3DCapture'] =
      function () {
        return (_JSPlayM4_GetD3DCapture = Module['_JSPlayM4_GetD3DCapture'] =
          Module['asm']['JSPlayM4_GetD3DCapture']).apply(null, arguments);
      });
    var __emscripten_tls_init = (Module['__emscripten_tls_init'] = function () {
      return (__emscripten_tls_init = Module['__emscripten_tls_init'] =
        Module['asm']['_emscripten_tls_init']).apply(null, arguments);
    });
    ...
    var ___getTypeName = function () {
      return (___getTypeName = Module['asm']['__getTypeName']).apply(
        null,
        arguments
      );
    };
    ...
    var __emscripten_thread_init = (Module['__emscripten_thread_init'] =
      function () {
        return (__emscripten_thread_init = Module['__emscripten_thread_init'] =
          Module['asm']['_emscripten_thread_init']).apply(null, arguments);
      });
    var __emscripten_thread_crashed = (Module['__emscripten_thread_crashed'] =
      function () {
        return (__emscripten_thread_crashed = Module[
          ...
          Module['asm']['_emscripten_thread_crashed']).apply(null, arguments);
      });
    ...
    var __emscripten_run_in_main_runtime_thread_js = function () {
      return (__emscripten_run_in_main_runtime_thread_js =
        Module['asm']['_emscripten_run_in_main_runtime_thread_js']).apply(
        null,
        arguments
      );
    };
    ...
    var __emscripten_thread_exit = (Module['__emscripten_thread_exit'] =
      function () {
        return (__emscripten_thread_exit = Module['__emscripten_thread_exit'] =
          Module['asm']['_emscripten_thread_exit']).apply(null, arguments);
      });
    ...
    var __emscripten_check_mailbox = (Module['__emscripten_check_mailbox'] =
      function () {
        return (__emscripten_check_mailbox = Module[
          ...
          Module['asm']['_emscripten_check_mailbox']).apply(null, arguments);
      });
