...
(function (event) {
  ...
  self.JSPlayM4_StreamInfoCallBack = function (nPort, pstStreamInfo, pUser) {
    ...
    postMessage({
      function: 'StreamInfoCallBack',
      nSystemformat: nSystemformat,
      nVideoformat: nVideoformat,
      nAudioformat: nAudioformat,
      nAudiochannels: nAudiochannels,
      nAudiobitspersample: nAudiobitspersample,
      nAudiosamplesrate: nAudiosamplesrate,
      nAudiobitrate: nAudiobitrate,
    });
  };
  ...
  onmessage = function (event) {
    ...
    switch (eventData.command) {
      ...
      case 'OpenStream':
        ...
        res = Module._OpenStream(
          g_nPort,
          pHead,
          iHeadLen,
          eventData.bufPoolSize
        );
      ...
      case 'InputData':
        ...
        if (iLen > 0) {
          ...
          if (sourceRemain == 0) {
            postMessage({
              function: 'InputData',
              errorCode: PLAYM4_NEED_MORE_DATA,
            });
            return;
          }
        }
      ...
      case 'SetLostFrameMode':
        ...
        break;
      case 'SetDemuxModel':
        let resSDM = Module._SetDemuxModel(
          g_nPort,
          eventData.nIdemuxType,
          eventData.bTrue
        );
        break;
      case 'SkipErrorData':
      ...
      case 'SetResampleValue':
        Module._SetResampleValue(
          g_nPort,
          eventData.nEnable,
          eventData.resampleValue
        );
        break;
      case 'GetLastError':
        let errorCode = Module._GetLastError(g_nPort);
