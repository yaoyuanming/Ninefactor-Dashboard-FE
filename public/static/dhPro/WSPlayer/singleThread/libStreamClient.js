var Single_Client_Module = (function () {
  ...
  return function (Single_Client_Module) {
    Single_Client_Module = Single_Client_Module || {};

    var Module =
      typeof Single_Client_Module !== 'undefined' ? Single_Client_Module : {};
    ...
    function _pthread_attr_setinheritsched() {
      err('missing function: pthread_attr_setinheritsched');
      abort(-1);
    }
    ...
    function _pthread_mutexattr_setrobust() {
      err('missing function: pthread_mutexattr_setrobust');
      abort(-1);
    }
    ...
    var asmLibraryArg = {
      ...
      mktime: _mktime,
      pthread_attr_setinheritsched: _pthread_attr_setinheritsched,
      pthread_attr_setschedpolicy: _pthread_attr_setschedpolicy,
      pthread_create: _pthread_create,
      pthread_mutexattr_setrobust: _pthread_mutexattr_setrobust,
