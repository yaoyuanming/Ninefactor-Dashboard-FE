var Multi_Client_Module = (function () {
  ...
  return function (Multi_Client_Module) {
    ...
    var Module =
      typeof Multi_Client_Module !== 'undefined' ? Multi_Client_Module : {};
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_GLOBAL_DecPlayInfo')
    ) {
      Object.defineProperty(Module['ready'], '_GLOBAL_DecPlayInfo', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _GLOBAL_DecPlayInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_GLOBAL_DecPlayInfo', {
        ...
        set: function () {
          abort(
            'You are setting _GLOBAL_DecPlayInfo on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_GLOBAL_SetLogLevel')
    ) {
      Object.defineProperty(Module['ready'], '_GLOBAL_SetLogLevel', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _GLOBAL_SetLogLevel on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_GLOBAL_SetLogLevel', {
        ...
        set: function () {
          abort(
            'You are setting _GLOBAL_SetLogLevel on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_InitSession')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_StartStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_PauseStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_ResumeStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_GetPlayInfo')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_PlayControl')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSP_SetMsgTimeout')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_InitSession')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_StartStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_SetWSSEInfo')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_PauseStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_ResumeStream')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_InitTalkInfo')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_PlayControl')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_RTSV_SetMsgTimeout')
    ) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_InitSession')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_InitSession', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_InitSession on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_InitSession', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_InitSession on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_SetLoginParam')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_SetLoginParam', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_SetLoginParam on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_SetLoginParam', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_SetLoginParam on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_StartStream')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_StartStream', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_StartStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_StartStream', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_StartStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_StopStream')) {
      Object.defineProperty(Module['ready'], '_VNSP_StopStream', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_StopStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_StopStream', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_StopStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_PauseStream')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_PauseStream', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_PauseStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_PauseStream', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_PauseStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_ResumeStream')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_ResumeStream', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_ResumeStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_ResumeStream', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_ResumeStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_SetPlayRange')
    ) {
      Object.defineProperty(Module['ready'], '_VNSP_SetPlayRange', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_SetPlayRange on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_SetPlayRange', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_SetPlayRange on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_FastPlay')) {
      Object.defineProperty(Module['ready'], '_VNSP_FastPlay', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_FastPlay on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_FastPlay', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_FastPlay on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_VNSP_PutStream')) {
      Object.defineProperty(Module['ready'], '_VNSP_PutStream', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _VNSP_PutStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_VNSP_PutStream', {
        ...
        set: function () {
          abort(
            'You are setting _VNSP_PutStream on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    ...
    function ___sys_getdents64(fd, dirp, count) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(5, 1, fd, dirp, count);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
        if (!stream.getdents) {
    ...
    function ___sys_poll(fds, nfds, timeout) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(9, 1, fds, nfds, timeout);
      try {
        var nonzero = 0;
    ...
    function ___sys_statfs64(path, size, buf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(13, 1, path, size, buf);
      try {
        path = SYSCALLS.getStr(path);
        assert(size === 64);
    ...
    function ___sys_unlink(path) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(14, 1, path);
      try {
        path = SYSCALLS.getStr(path);
        FS.unlink(path);
        return 0;
    ...
    function _cPlusRtspMsgCallBack(handle, type, attach) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(16, 0, handle, type, attach);
      cPlusRtspMsgCallBack(handle, type, attach);
    }
    function _cPlusRtsvMsgCallBack(handle, type, attach) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(17, 0, handle, type, attach);
      cPlusRtsvMsgCallBack(handle, type, attach);
    }
    function _cPlusVnspMsgCallBack(handle, type, attach) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(18, 0, handle, type, attach);
      cPlusVnspMsgCallBack(handle, type, attach);
    }
    ...
    function _emscripten_websocket_delete(socketId) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(21, 1, socketId);
      var socket = WS.sockets[socketId];
      if (!socket) {
        return -3;
      }
    ...
    function _emscripten_websocket_new(createAttributes) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(23, 1, createAttributes);
    ...
    function _emscripten_websocket_send_binary(
      ...
      socket.send(
        new Uint8Array(
          GROWABLE_HEAP_U8().subarray(binaryData, binaryData + dataLength)
        )
      );
      return 0;
    }
    function _emscripten_websocket_send_utf8_text(socketId, textData) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(25, 1, socketId, textData);
      var socket = WS.sockets[socketId];
      if (!socket) {
        return -3;
      }
    ...
    function _emscripten_websocket_set_onclose_callback_on_thread(
      ...
      socket.onclose = function (e) {
        ...
        stringToUTF8(
          e.reason,
          GROWABLE_HEAP_U32()[(WS.socketEvent + 10) >> 2],
          512
        );
    ...
    function _fd_fdstat_get(fd, pbuf) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(33, 1, fd, pbuf);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
        var type = stream.tty
          ? 2
    ...
    function _fd_sync(fd) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(36, 1, fd);
      try {
        var stream = SYSCALLS.getStreamFromFD(fd);
    ...
    function _sysconf(name) {
      if (ENVIRONMENT_IS_PTHREAD)
        return _emscripten_proxy_to_main_thread_js(39, 1, name);
      switch (name) {
        case 30:
          return 16384;
        case 85:
    ...
    var asmLibraryArg = {
      ...
      cPlusVnspMsgCallBack: _cPlusVnspMsgCallBack,
    ...
    var _GLOBAL_Init = (Module['_GLOBAL_Init'] =
      createExportWrapper('GLOBAL_Init'));
    var _GLOBAL_Uninit = (Module['_GLOBAL_Uninit'] =
      createExportWrapper('GLOBAL_Uninit'));
    var _GLOBAL_SetLogLevel = (Module['_GLOBAL_SetLogLevel'] =
      createExportWrapper('GLOBAL_SetLogLevel'));
    var _RTSP_InitSession = (Module['_RTSP_InitSession'] =
      createExportWrapper('RTSP_InitSession'));
    var _RTSP_StartStream = (Module['_RTSP_StartStream'] =
      createExportWrapper('RTSP_StartStream'));
    var _RTSP_StopStream = (Module['_RTSP_StopStream'] =
      createExportWrapper('RTSP_StopStream'));
    var _RTSP_PauseStream = (Module['_RTSP_PauseStream'] =
      createExportWrapper('RTSP_PauseStream'));
    var _RTSP_ResumeStream = (Module['_RTSP_ResumeStream'] =
      createExportWrapper('RTSP_ResumeStream'));
    var _RTSP_GetPlayInfo = (Module['_RTSP_GetPlayInfo'] =
      createExportWrapper('RTSP_GetPlayInfo'));
    var _RTSP_PlayControl = (Module['_RTSP_PlayControl'] =
      createExportWrapper('RTSP_PlayControl'));
    var _RTSP_PutStream = (Module['_RTSP_PutStream'] =
      createExportWrapper('RTSP_PutStream'));
    var _RTSP_SetMsgTimeout = (Module['_RTSP_SetMsgTimeout'] =
      createExportWrapper('RTSP_SetMsgTimeout'));
    var _RTSV_InitSession = (Module['_RTSV_InitSession'] =
      createExportWrapper('RTSV_InitSession'));
    var _RTSV_SetWSSEInfo = (Module['_RTSV_SetWSSEInfo'] =
      createExportWrapper('RTSV_SetWSSEInfo'));
    var _RTSV_StartStream = (Module['_RTSV_StartStream'] =
      createExportWrapper('RTSV_StartStream'));
    var _RTSV_StopStream = (Module['_RTSV_StopStream'] =
      createExportWrapper('RTSV_StopStream'));
    var _RTSV_PauseStream = (Module['_RTSV_PauseStream'] =
      createExportWrapper('RTSV_PauseStream'));
    var _RTSV_ResumeStream = (Module['_RTSV_ResumeStream'] =
      createExportWrapper('RTSV_ResumeStream'));
    var _RTSV_PlayControl = (Module['_RTSV_PlayControl'] =
      createExportWrapper('RTSV_PlayControl'));
    var _RTSV_InitTalkInfo = (Module['_RTSV_InitTalkInfo'] =
      createExportWrapper('RTSV_InitTalkInfo'));
    var _RTSV_PutStream = (Module['_RTSV_PutStream'] =
      createExportWrapper('RTSV_PutStream'));
    var _RTSV_SetMsgTimeout = (Module['_RTSV_SetMsgTimeout'] =
      createExportWrapper('RTSV_SetMsgTimeout'));
    var _GLOBAL_DecPlayInfo = (Module['_GLOBAL_DecPlayInfo'] =
      createExportWrapper('GLOBAL_DecPlayInfo'));
    var _VNSP_InitSession = (Module['_VNSP_InitSession'] =
      createExportWrapper('VNSP_InitSession'));
    var _VNSP_SetLoginParam = (Module['_VNSP_SetLoginParam'] =
      createExportWrapper('VNSP_SetLoginParam'));
    var _VNSP_StartStream = (Module['_VNSP_StartStream'] =
      createExportWrapper('VNSP_StartStream'));
    var _VNSP_StopStream = (Module['_VNSP_StopStream'] =
      createExportWrapper('VNSP_StopStream'));
    var _VNSP_PauseStream = (Module['_VNSP_PauseStream'] =
      createExportWrapper('VNSP_PauseStream'));
    var _VNSP_ResumeStream = (Module['_VNSP_ResumeStream'] =
      createExportWrapper('VNSP_ResumeStream'));
    var _VNSP_SetPlayRange = (Module['_VNSP_SetPlayRange'] =
      createExportWrapper('VNSP_SetPlayRange'));
    var _VNSP_FastPlay = (Module['_VNSP_FastPlay'] =
      createExportWrapper('VNSP_FastPlay'));
    var _VNSP_PutStream = (Module['_VNSP_PutStream'] =
      createExportWrapper('VNSP_PutStream'));
    ...
    var dynCall_iijjffii = (Module['dynCall_iijjffii'] =
      createExportWrapper('dynCall_iijjffii'));
    var dynCall_iiijjffiii = (Module['dynCall_iiijjffiii'] =
      createExportWrapper('dynCall_iiijjffiii'));
