var H264Enc = (function () {
  ...
  return function (H264Enc) {
    H264Enc = H264Enc || {};

    var Module = typeof H264Enc !== 'undefined' ? H264Enc : {};
    var readyPromiseResolve, readyPromiseReject;
    Module['ready'] = new Promise(function (resolve, reject) {
      readyPromiseResolve = resolve;
      readyPromiseReject = reject;
    });
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_h264Enc')) {
      Object.defineProperty(Module['ready'], '_h264Enc', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _h264Enc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_h264Enc', {
        ...
        set: function () {
          abort(
            'You are setting _h264Enc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (!Object.getOwnPropertyDescriptor(Module['ready'], '_h264EncClose')) {
      Object.defineProperty(Module['ready'], '_h264EncClose', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _h264EncClose on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_h264EncClose', {
        ...
        set: function () {
          abort(
            'You are setting _h264EncClose on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    ...
    var wasmBinaryFile = 'libH264Enc.wasm';
    ...
    function _cPlusH264EncCallBack(pBuf, nLen, pFrameInfo) {
      cPlusH264EncCallBack(pBuf, nLen, pFrameInfo);
    }
    ...
    var asmLibraryArg = {
      ...
      abort: _abort,
      cPlusH264EncCallBack: _cPlusH264EncCallBack,
      ...
      pthread_attr_setscope: _pthread_attr_setscope,
    ...
    var _h264Enc = (Module['_h264Enc'] = createExportWrapper('h264Enc'));
    var _h264EncClose = (Module['_h264EncClose'] =
      createExportWrapper('h264EncClose'));
...
else if (typeof exports === 'object') exports['H264Enc'] = H264Enc;
