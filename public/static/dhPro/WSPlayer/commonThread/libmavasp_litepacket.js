var ASPLite_Module = (function () {
  ...
  return function (ASPLite_Module) {
    ...
    if (
      !Object.getOwnPropertyDescriptor(
        Module['ready'],
        '_Audio_Framework_GetVersion'
      )
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_GetVersion', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_GetVersion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_GetVersion', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_GetVersion on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_Audio_Framework_Init')
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_Init', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_Init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_Init', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_Init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(
        Module['ready'],
        '_Audio_Framework_Config'
      )
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_Config', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_Config on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_Config', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_Config on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(Module['ready'], '_Audio_Framework_Main')
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_Main', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_Main on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_Main', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_Main on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(
        Module['ready'],
        '_Audio_Framework_Main_REF'
      )
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_Main_REF', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_Main_REF on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_Main_REF', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_Main_REF on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(
        Module['ready'],
        '_Audio_Framework_Flushout'
      )
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_Flushout', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_Flushout on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_Flushout', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_Flushout on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    if (
      !Object.getOwnPropertyDescriptor(
        Module['ready'],
        '_Audio_Framework_DeInit'
      )
    ) {
      Object.defineProperty(Module['ready'], '_Audio_Framework_DeInit', {
        configurable: true,
        get: function () {
          abort(
            'You are getting _Audio_Framework_DeInit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
      Object.defineProperty(Module['ready'], '_Audio_Framework_DeInit', {
        ...
        set: function () {
          abort(
            'You are setting _Audio_Framework_DeInit on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js'
          );
        },
      });
    }
    ...
    (function () {
      var loadPackage = function (metadata) {
        ...
        var PACKAGE_NAME = './libmavasp_litepacket.data';
        var REMOTE_PACKAGE_BASE = 'libmavasp_litepacket.data';
        if (
        ...
        function runWithFS() {
          ...
          function processPackageData(arrayBuffer) {
            ...
            Module['removeRunDependency'](
              'datafile_./libmavasp_litepacket.data'
            );
          }
          Module['addRunDependency']('datafile_./libmavasp_litepacket.data');
      ...
      loadPackage({
        files: [{ filename: '/ASPLite.cfg', start: 0, end: 1028, audio: 0 }],
        remote_package_size: 1028,
        package_uuid: '083d11e9-fee5-4758-ace5-d23e2b0d2b2d',
      });
    })();
    ...
    var wasmBinaryFile = 'libmavasp_litepacket.wasm';
    ...
    var _Audio_Framework_GetVersion = (Module['_Audio_Framework_GetVersion'] =
      createExportWrapper('Audio_Framework_GetVersion'));
    var _Audio_Framework_Init = (Module['_Audio_Framework_Init'] =
      createExportWrapper('Audio_Framework_Init'));
    var _Audio_Framework_Config = (Module['_Audio_Framework_Config'] =
      createExportWrapper('Audio_Framework_Config'));
    var _Audio_Framework_Main = (Module['_Audio_Framework_Main'] =
      createExportWrapper('Audio_Framework_Main'));
    var _Audio_Framework_Main_REF = (Module['_Audio_Framework_Main_REF'] =
      createExportWrapper('Audio_Framework_Main_REF'));
    var _Audio_Framework_Flushout = (Module['_Audio_Framework_Flushout'] =
      createExportWrapper('Audio_Framework_Flushout'));
    var _Audio_Framework_DeInit = (Module['_Audio_Framework_DeInit'] =
      createExportWrapper('Audio_Framework_DeInit'));
