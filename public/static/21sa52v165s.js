window.TMAP_AUTHKEY = '5f3d5e07ab4e9727500d388f2f367ac6';
window.T = window.T || {};
(function () {
  function each(t, i) {
  ...
  (T.Version = '4.1.6'),
    ...
    (T.w = {
      ...
      R:
        ...
        'api.tianditu.' +
        T.Domain +
        '/apiserver/ajaxproxy?proxyReqUrl=',
      r: function () {
        return (
          T.Protocol.value +
          't' +
    ...
    (T.S = {
      ...
      G: function (t, i, n) {
        ...
        return (
          ...
          (s = function () {
            e
              ? (o = arguments)
              : (t.apply(n, arguments), setTimeout(r, i), (e = !0));
          })
        );
      },
      g: function (t, i, n) {
      ...
      setOptions: function (t, i) {
        t.hasOwnProperty('options') ||
          (t.options = t.options ? T.S.s(t.options) : {});
    ...
    (T.c.extend = function (t) {
      ...
      return (
        ...
        t.includes &&
          (T.S.extend.apply(null, [e].concat(t.includes)), delete t.includes),
    ...
    (T.c._ = function (t) {
      ...
      return (
        (this.prototype.N = this.prototype.N || []),
    ...
    (T.m = T.c.extend({
      ...
      WQ: function (t, i, n) {
        ...
        if (h) {
          if (!i) {
            ...
            for (o = h[t] || [], s = 0, r = o.length; s < r; s++)
              o[s].fn = T.S.H;
      ...
      wQ: function (t, i, n) {
        ...
        var e = T.S.extend({}, i, { type: t, target: this }),
          o = this.qQ;
        if (o) {
          var s,
            r,
            ...
            u = o[t + '_idx'];
          if (o[t])
            for (h = o[t].slice(), s = 0, r = h.length; s < r; s++)
              h[s].fn.call(this, e);
      ...
      eQ: function (t) {
        for (var i in this.RQ)
          this.RQ[i].wQ(t.type, T.extend({ layer: t.target }, t), !0);
      },
    }));
  ...
  (pro.addEventListener = pro.on),
    ...
    (function () {
      ...
      T.oQ = {
        ...
        pointer: !!p,
        retina:
          (window.PQ || window.screen.deviceXDPI / window.screen.logicalXDPI) >
          1,
      };
    })(),
    ...
    (T.ZQ.prototype = {
      ...
      contains: function (t) {
        ...
        return (
          (t =
            'number' == typeof t[0] || t instanceof T.Point
              ? T.SQ(t)
              : T.cQ(t)),
    ...
    (T._Q = {
      ...
      tq: function (t, i) {
        ...
        (i = Math.round(100 * i)),
          n
            ? ((n.Enabled = 100 !== i), (n.Opacity = i))
            : (t.style.filter += ' progid:' + e + '(opacity=' + i + ')');
      },
      Yq: function (t) {
    ...
    (function () {
      ...
      if (
        ((T._Q.iq =
          'webkitTransition' === t || 'OTransition' === t
            ? t + 'End'
            : 'transitionend'),
        ...
        (T._Q.Oq = function () {
          ...
          (T._Q.Pq = function () {
            i &&
              ((document.documentElement.style[i] = this.pq), delete this.pq);
          });
      }
      (T._Q.Aq = function () {
    ...
    (T.Kq.prototype = {
      ...
      lq: function (t) {
        ...
        return new T.Kq(
          new T.dq(i.lat - e, i.lng - o),
          new T.dq(n.lat + e, n.lng + o)
        );
      },
      getCenter: function () {
        return new T.dq(
          (this.kq.lat + this.Lq.lat) / 2,
          (this.kq.lng + this.Lq.lng) / 2
        );
      },
      ...
      contains: function (t) {
        ...
        return (
          t instanceof T.Kq
            ? ((i = t.getSouthWest()), (n = t.getNorthEast()))
            : (i = n = t),
    ...
    (T.gq.Gq = T.extend({}, T.gq, {
      ...
      distance: function (t, i) {
        var n = Math.PI / 180,
          ...
          o = i.lat * n,
          s =
            Math.sin(e) * Math.sin(o) +
            Math.cos(e) * Math.cos(o) * Math.cos((i.lng - t.lng) * n);
    ...
    (T.gq.UW = T.extend({}, T.gq.tW, { code: 'EPSG:900913' })),
    ...
    (T.Map = T.m.extend({
      ...
      initialize: function (t, i) {
        (i = T.setOptions(this, i)),
          ...
          i.center &&
            void 0 !== i.zoom &&
            this.gW(T.fq(i.center), i.zoom, { reset: !0 }),
          (this.HW = []),
          (this.hW = {}),
          (this.JW = []),
          (this.jW = []),
      ...
      gW: function (t, i) {
        return (
          (i = void 0 === i ? this.getZoom() : i), this.ZW(T.fq(t), i), this
        );
      },
      setZoom: function (t, i) {
        return this.CW
          ? this.gW(this.getCenter(), t, { zoom: i })
          : ((this.fW = t), this);
      },
      zoomIn: function (t, i) {
        return (
          (t = t || (T.oQ.any3d ? this.options.aW : 1)),
      ...
      Qw: function (t) {
        for (
          var i = new T.LngLatBounds(new T.LngLat(0, 0)), n = 0, e = t.length;
          n < e;
          n++
        ) {
          var o = T.fq(t[n]);
        ...
        return s.x || s.y
          ? (t.Tw && t.qw
              ...
              : (t.qw && this.Ww(s),
                this.wQ('move'),
                t.Yw
                  ? (clearTimeout(this.Uw),
                    (this.Uw = setTimeout(T.D(this.wQ, this, 'moveend'), 200)))
                  : this.wQ('moveend')),
            this.wQ('resize', { oldSize: i, newSize: n }))
          : this;
      },
      ...
      Aw: function (t, i) {
        var n =
            'tdt-pane' + (t ? ' tdt-' + t.replace('Pane', '') + '-pane' : ''),
      ...
      getSize: function () {
        return (
          (this.Hw && !this.kW) ||
            ((this.Hw = new T.Point(this.Ow.clientWidth, this.Ow.clientHeight)),
            (this.kW = !1)),
          this.Hw.pQ()
        );
      },
      ...
      gw: function (t, i) {
        var n = this.options.IW;
        return (
          (i = void 0 === i ? this.fW : i), n.zoom(t * n.scale(i + T.gq.EW))
        );
      },
      setCrs: function (t) {
      ...
      bw: function () {
        ...
        (this.nw = {}),
          ...
          this.options.PW ||
            (T._Q.Rq(t.markerPane, 'tdt-zoom-hide'),
      ...
      TE: function () {
        var t = this.lw();
        Math.max(Math.abs(t.x), Math.abs(t.y)) >= this.options.pW &&
          ...
          for (var h = 0; h < n.length; h++)
            if (
              ...
              s.originalEvent._stopped ||
                (n[h].options.pE && T.S.indexOf(n[h].options.pE, i) !== -1))
            )
              return;
        }
      },
      ...
      sE: function (t, i) {
        return (
          this.CW ? t.call(i || this, { target: this }) : this.on('load', t, i),
          this
        );
      },
      lw: function () {
      ...
      FE: function (t, i, n) {
        var e = T.cQ(
            this.nq(i.getNorthEast(), n),
            this.nq(i.getSouthWest(), n)
          ),
          o = e.min.sQ(t.min),
          s = e.max.sQ(t.max),
          r = this.GE(o.x, -s.x),
      ...
      setStyle: function (t) {
        (t = t || 'black'),
          'black' == t
            ? (this.Ow.style.backgroundColor = '#000000')
            : (this.Ow.style.backgroundColor = '#466399'),
    ...
    T.Map.M({
      addLayer: function (t) {
        ...
        return this.hW[i]
          ? this
          : ((this.hW[i] = t),
            'undefined' != typeof this.hW[i].options.type &&
              this.JW.push(this.hW[i]),
            (t.KE = this),
            t.vE && t.vE(this),
            this.sE(t.lE, t),
            this);
      ...
      removeLayer: function (t) {
        ...
        return this.hW[i]
          ? (this.CW && t.onRemove(this),
            ...
            delete this.hW[i],
            this.CW && (this.wQ('layerremove', { layer: t }), t.wQ('remove')),
            (t.jE = t.KE = null),
            this)
          : this;
      },
      ...
      setMapType: function (t) {
        t &&
          (this.defaultMapType && this.clearMapType(this.defaultMapType),
          this.addLayer(t),
          (this.defaultMapType = t)),
          this.wQ('maptypechange', { mapType: t });
      },
    ...
    (T.ScriptLoader.prototype = {
          ...
          (this.oScript.onload = this.oScript.onreadystatechange =
            function () {
              (this.readyState &&
                ...
                ((n.oScript.onload = n.oScript.onreadystatechange = null),
                n.Qe());
            }),
            o.document.body.insertBefore(
              this.oScript,
      ...
      Qe: function (t) {
        ...
        !document.all &&
          ...
          (this.oScript.removeAttribute('src'),
    ...
    (T.ScriptLoader.qe = function (t) {
      return t && t.ownerDocument && t.ownerDocument.parentWindow
    ...
    (T.bq.we = {
      ...
      nq: function (t) {
        var i = Math.PI / 180,
          ...
          r = s * Math.sin(e),
          h =
            Math.tan(Math.PI / 4 - e / 2) / Math.pow((1 - r) / (1 + r), s / 2);
        return (
          (e = -n * Math.log(Math.max(h, 1e-10))), new T.Point(t.lng * i * n, e)
        );
      },
      _q: function (t) {
        for (
    ...
    (T.re = T.HE.extend({
      ...
      CE: function () {
        ...
        return (
          this.options.te ||
            (this.fe || (this.fe = T.S.G(this.TE, this.options.Ye, this)),
            (t.move = this.fe)),
      ...
      sW: function () {
        this.Ow ||
          ((this.Ow = T._Q.s(
            'div',
            'tdt-layer ' + (this.options.className || '')
          )),
          this.se(),
        ...
        if (void 0 !== t) {
          ...
          return (
            e ||
              ...
              (e.el = T._Q.s(
                'div',
                'tdt-tile-container tdt-zoom-animated',
                this.Ow
              )),
              (e.el.style.zIndex = i),
        ...
        if (this.jE) {
          ...
          for (t in this.ie)
            if (((i = this.ie[t]), i.Je && !i.active)) {
              var e = i.coords;
              this.Ve(e.x, e.y, e.z, e.z - 5) ||
                this.ce(e.x, e.y, e.z, e.z + 2);
            }
      ...
      Ve: function (t, i, n, e) {
        ...
        return u && u.active
          ? ((u.retain = !0), !0)
          : (u && u.loaded && (u.retain = !0), r > e && this.Ve(o, s, r, e));
      },
      ce: function (t, i, n, e) {
      ...
      ne: function () {
        ...
        o && (this.QR = this.qR(o)),
          (this.WR = i.rW &&
            !this.options.ue && [
              Math.floor(t.nq([0, i.rW[0]], e).x / n.x),
              Math.ceil(t.nq([0, i.rW[1]], e).x / n.y),
            ]),
          (this.wR = i.wrapLat &&
            !this.options.ue && [
        ...
        if (i) {
          ...
          if ((void 0 === t && (t = i.getCenter()), void 0 !== this.Pe)) {
            ...
            for (var u in this.ie) {
              ...
              (c.z === this.Pe && a.contains(T.SQ(c.x, c.y))) ||
                (this.ie[u].Je = !1);
            }
      ...
      Be: function (t) {
        ...
        i &&
          (T._Q.Qq(i.el),
          delete this.ie[t],
          this.wQ('tileunload', { tile: i.el, coords: this.UR(t) }));
      },
      uR: function (t) {
        T._Q.Rq(t, 'tdt-tile');
        var i = this.he();
        (t.style.width = i.x + 'px'),
          ...
          T.oQ.ielt9 &&
            ...
            T._Q.setOpacity(t, this.options.opacity),
          T.oQ.android &&
            !T.oQ.android23 &&
      ...
      TR: function (t, i) {
        ...
        this.uR(o),
          ...
          (this.ie[e] = { el: o, coords: t, Je: !0 }),
          i.appendChild(o),
          this.wQ('tileloadstart', { tile: o, coords: t });
      },
      OR: function (t, i, n) {
        if (this.jE) {
          ...
          (n = this.ie[e]),
            n &&
              ((n.loaded = +new Date()),
              this.jE.Nw
                ? (T._Q.setOpacity(n.el, 0),
                  T.S.V(this.ke),
                  (this.ke = T.S.C(this.Se, this)))
                : ((n.active = !0), this.Ke()),
              T._Q.Rq(n.el, 'tdt-tile-loaded'),
              this.wQ('tileload', { tile: n.el, coords: t }),
              this.oR() &&
                ((this.de = !1),
                this.wQ('load'),
                T.oQ.ielt9 || !this.jE.Nw
                  ? T.S.C(this.Ke, this)
                  : setTimeout(T.D(this.Ke, this), 250)));
        }
      },
      IR: function (t) {
      ...
      iR: function (t) {
        var i = new T.Point(
          this.WR ? T.S.g(t.x, this.WR) : t.x,
          this.wR ? T.S.g(t.y, this.wR) : t.y
        );
        return (i.z = t.z), i;
      },
      qR: function (t) {
      ...
      Me: function () {
        ...
        for (t in this.ie)
          this.ie[t].coords.z !== this.Pe &&
            ...
            (i.onload = T.S.H),
            (i.onerror = T.S.H),
            i.complete || ((i.src = T.S.Z), T._Q.Qq(i)));
      },
    })),
    (T.JR = function (t, i) {
    ...
    (T.TileLayer.WMS = T.TileLayer.extend({
      ...
      getTileUrl: function (t) {
        ...
        return (
          s +
          T.S.K(this.KR, s, this.options.jR) +
          (this.options.jR ? '&BBOX=' : '&bbox=') +
          o
        );
      },
    ...
    (T.lR = {
      ...
      MR: function (t, i) {
        ...
        if (window.localStorage) {
          ...
          this.ZR != localStorage.getItem('TDT_version')
            ? (T.lR.vR(i),
              i.indexOf('tianditu4.0') != -1 &&
                (i = T.w.E + '/api?v=4.0&name=tianditu4.0'),
              T.lR.bR(i, function () {
      ...
      nR: function (t, i) {
        ...
        if (window.localStorage) {
          ...
          this.ZR != localStorage.getItem('TDT_version')
            ? (T.lR.cR(i),
              i.indexOf('components') != -1 &&
                (i =
                  T.w.E + '/api?v=4.0&name=components&tk=' + T.w.TMAP_AUTHKEY),
              i.indexOf('service') != -1 &&
                (i = T.w.E + '/api?v=4.0&name=service&tk=' + T.w.TMAP_AUTHKEY),
              i.indexOf('military') != -1 &&
                (i = T.w.E + '/api?v=4.0&name=military&tk=' + T.w.TMAP_AUTHKEY),
              T.lR.bR(i, function () {
                T.ObjectData && (n = T.ObjectData),
                  localStorage.setItem(t, n),
                  localStorage.setItem('TDT_version', T.lR.ZR),
    ...
    (T._R = T.HE.extend({
      options: { opacity: 1, Fq: '', mR: !1, Ue: null, dR: !1 },
      ...
      onAdd: function () {
        this.qr || (this.Wr(), this.options.opacity < 1 && this.Se()),
          this.options.mR &&
            (T._Q.Rq(this.qr, 'tdt-interactive'), this.kE(this.qr)),
      ...
      Wr: function () {
        var t = (this.qr = T._Q.s(
          'img',
          'tdt-image-layer ' + (this.ZE ? 'tdt-zoom-animated' : '')
        ));
        (t.onselectstart = T.S.H),
          (t.onmousemove = T.S.H),
    ...
    (T.Icon = T.c.extend({
      ...
      rr: function (t, i) {
        var n = this.tr(t);
        return n
          ? ((this.img = this.Yr(n, i && 'IMG' === i.tagName ? i : null)),
            this.er(this.img, t),
            this.img)
          : null;
      },
      er: function (t, i) {
        ...
        var o = T.SQ(e),
          s = T.SQ(
            ('shadow' === i && n.Ur) || n.iconAnchor || (o && o.dQ(2, !0))
          );
      ...
      tr: function (t) {
        return (
          (T.oQ.retina && this.options[t + 'RetinaUrl']) ||
          this.options[t + 'Url']
        );
      },
    })),
    ...
    (T.Icon.Default.imagePath = (function () {
      ...
      for (t = 0, i = o.length; t < i; t++)
        if (((n = o[t].src || ''), n.match(s)))
          return (e = n.split(s)[0]), (e ? e + '/' : '') + 'image';
    })()),
    ...
    (T.Marker = T.Overlay.extend({
      ...
      onRemove: function (t) {
        this.AE &&
          this.AE.aE() &&
          ((this.options.draggable = !0), this.AE.Ar()),
      ...
      sr: function (t) {
        ...
        return (
          (this.or = T.fq(t)),
          this.update(),
          this.wQ('move', { oldLngLat: i, lnglat: this.or })
        );
      },
      ...
      pr: function () {
        ...
        n !== this.Fr &&
          ...
          t.Ir && (n.tabIndex = '0'),
          (this.Fr = n),
          t.ir && this.on({ mouseover: this.Gr, mouseout: this.gr });
      ...
      ar: function () {
        this.options.ir && this.off({ mouseover: this.Gr, mouseout: this.gr }),
          T._Q.Qq(this.Fr),
          this.LE(this.Fr),
          (this.Fr = null);
      },
      ...
      hr: function () {
        if (
          this.options.mR &&
          (T._Q.Rq(this.Fr, 'tdt-interactive'), this.kE(this.Fr), T.Kr.jr)
        ) {
    ...
    (T.Zr = T.HE.extend({
      ...
      onAdd: function (t) {
        (this.ZE = this.ZE && this.options.Nr),
          ...
          t.wQ('nr', { _r: this }),
          this.wQ('open', { lnglat: this.or }),
          this.br &&
            (this.br.wQ('nr', { _r: this }, !0),
      ...
      onRemove: function (t) {
        t.Nw
          ? (T._Q.setOpacity(this.Ow, 0),
            (this.Mr = setTimeout(T.D(T._Q.Qq, T._Q, this.Ow), 200)))
          : T._Q.Qq(this.Ow),
          t.wQ('qT', { _r: this }),
          this.wQ('close', { lnglat: this.or, infowindow: this }),
          this.br &&
            (this.br.wQ('qT', { _r: this }, !0),
      ...
      CE: function () {
        ...
        return (
          ...
          ('closeOnClick' in this.options
            ...
            : this.jE.options.lr) && (t.UE = this.rT),
      ...
      eT: function () {
        if (this.ET) {
          var t = this.uT,
            i =
              'function' == typeof this.ET ? this.ET(this.br || this) : this.ET;
    ...
    T.Map.M({
      QT: function (t, i, n) {
        return (
          ...
          this.hasLayer(t)
            ? this
            : (this.Dr && this.Dr.options.Br && this.TT(),
              (this.Dr = t),
              this.addLayer(t))
        );
      },
      ...
      TT: function (t) {
        return (
          (t && t !== this.Dr) || ((t = this.Dr), (this.Dr = null)),
    ...
    T.HE.M({
      dr: function (t, i) {
        return (
          t instanceof T.Zr
            ...
            : ((this.Dr && !i) || (this.Dr = new T.Zr(i, this)),
              this.Dr.setContent(t)),
          this.DT || (this.on({ Qq: this.TT, move: this.dT }), (this.DT = !0)),
          this
        );
      },
      FT: function () {
        return (
          this.Dr &&
            (this.off({ Qq: this.TT, move: this.dT }),
            (this.DT = !1),
            (this.Dr = null)),
          this
        );
      ...
      QT: function (t, i) {
        ...
        return (
          ...
          this.Dr &&
            this.jE &&
            ((this.Dr.br = t), this.Dr.update(), this.jE.QT(this.Dr, i)),
          this
        );
      },
      TT: function () {
        ...
        if (this.Dr && this.jE)
          return (
            ...
            i instanceof T.jT
              ...
              : void (this.jE.hasLayer(this.Dr) && this.Dr.br === i
                  ? this.TT()
                  : this.QT(i, t.KT))
          );
      },
    ...
    (T.LayerGroup = T.HE.extend({
      ...
      removeLayer: function (t) {
        ...
        return (
          this.jE && this.hW[i] && this.jE.removeLayer(this.hW[i]),
          delete this.hW[i],
          this
        );
      },
    ...
    T.Map.M({
      LW: function (t) {
        ...
        (r.getTileUrl = function (t) {
          ...
          (TMAP_TERRAIN_HYBRID_MAP = new T.MapType(
            [s, r],
    ...
    (T.ZT = T.HE.extend({
      ...
      onAdd: function () {
        this.Ow ||
          (this.sW(), this.ZE && T._Q.Rq(this.Ow, 'tdt-zoom-animated')),
          this.getPane().appendChild(this.Ow),
          this.Oe();
      },
      onRemove: function () {
    ...
    T.Map.M({
      vT: function (t) {
        var i =
          t.options.iW || this.NT(t.options.hE) || this.options.iW || this.bT;
        return (
          i || (i = this.bT = (this.options._T && T.nT()) || T.MT()),
      ...
      NT: function (t) {
        ...
        return (
          void 0 === i &&
            ((i = (T.SVG && T.MT({ hE: t })) || (T.mT && T.nT({ hE: t }))),
            (this.nw[t] = i)),
          i
        );
      },
    ...
    (T.ut = {
      ...
      Dt: function (t, i) {
        var n = 0;
        return (
          t.x < i.min.x ? (n |= 1) : t.x > i.max.x && (n |= 2),
    ...
    (T.Polyline = T.jT.extend({
      ...
      setLineStyle: function (t) {
        'dashed' == t
          ? ((this.gt = 'dashed'),
            T.oQ.ie8 || T.oQ.ie7
              ? this.setStyle({ dashArray: '2,2' })
              : this.setStyle({ dashArray: '4' }))
          : ((this.gt = 'solid'), this.setStyle({ dashArray: '' }));
      },
      ...
      kt: function (t) {
        for (
          var i, n, e = 1 / 0, o = null, s = T.ut.Pt, r = 0, h = this.Lt.length;
          r < h;
          r++
        )
      ...
      getCenter: function () {
        ...
        for (t = 0, e = 0; t < a - 1; t++)
          if (
            ((o = h[t]), (s = h[t + 1]), (n = o.distanceTo(s)), (e += n), e > i)
          )
            return (
              (r = (e - i) / n),
      ...
      Vt: function (t) {
        for (var i = [], n = T.Polyline.ct(t), e = 0, o = t.length; e < o; e++)
          n
            ? ((i[e] = T.fq(t[e])), this.Qr.extend(i[e]))
            : (i[e] = this.Vt(t[e]));
        return i;
      },
      Rt: function () {
      ...
      Bt: function (t, i, n) {
        ...
        if (s) {
          for (o = [], e = 0; e < r; e++)
            (o[e] = this.jE.kw(t[e])), n.extend(o[e]);
          i.push(o);
            ...
            for (h = this.lt[i], n = 0, s = h.length; n < s - 1; n++)
              (r = T.ut.St(h[n], h[n + 1], t, n, !0)),
                r &&
                  ((a[e] = a[e] || []),
                  a[e].push(r[0]),
                  (r[1] === h[n + 1] && n !== s - 2) || (a[e].push(r[1]), e++));
        }
      },
      bt: function () {
        for (
          var t = this.Lt, i = this.options.Ft, n = 0, e = t.length;
          n < e;
          n++
        )
          t[n] = T.ut.It(t[n], i);
      ...
      for (r = 0; r < 4; r++) {
        for (c = f[r], e = [], o = 0, u = t.length, s = u - 1; o < u; s = o++)
          (h = t[o]),
            ...
            h._code & c
              ? a._code & c ||
                ((l = d.dt(a, h, c, i, n)), (l._code = d.Dt(l, i)), e.push(l))
              : (a._code & c &&
                  ((l = d.dt(a, h, c, i, n)),
                  (l._code = d.Dt(l, i)),
                  e.push(l)),
    ...
    (T.Polygon = T.Polyline.extend({
      ...
      Vt: function (t) {
        var i = T.Polyline.prototype.Vt.call(this, t),
          n = i.length;
        return (
          n >= 2 && i[0] instanceof T.dq && i[0].equals(i[n - 1]) && i.pop(), i
        );
      },
      Gt: function (t) {
      ...
      Nt: function () {
        var t = this.bT.Qr,
          ...
          n = new T.Point(i, i);
        if (
          ((t = new T.ZQ(t.min.sQ(n), t.max.AQ(n))),
          (this.Lt = []),
    ...
    (T.Rectangle = T.Polygon.extend({
      ...
      qY: function (t) {
        return (
          (t = T.jq(t)), [t.getSouthWest(), t.Zq(), t.getNorthEast(), t.cq()]
        );
      },
    })),
    (T.WY = function (t, i) {
    ...
    (T.wY = T.jT.extend({
      options: { fill: !0, radius: 10, type: 8 },
      initialize: function (t, i) {
        T.setOptions(this, i),
          (this.or = T.fq(t)),
      ...
      sr: function (t) {
        return (
          (this.or = T.fq(t)), this.redraw(), this.wQ('move', { KT: this.or })
        );
      },
      PE: function () {
        return this.or;
    ...
    (T.Circle = T.wY.extend({
      initialize: function (t, i, n) {
        'number' == typeof i && (i = T.extend({}, n, { radius: i })),
          T.setOptions(this, i),
          (this.or = T.fq(t)),
      ...
      Rt: function () {
        ...
        if (e.distance === T.gq.Gq.distance) {
          ...
          (isNaN(c) || 0 === c) && (c = s / Math.cos((Math.PI / 180) * i)),
            ...
            (this.EY = isNaN(c)
              ? 0
              : Math.max(Math.round(a.x - n.nq([u, t - c]).x), 1)),
        ...
        i &&
          (n.stroke
            ? (i.setAttribute('stroke', n.color),
              ...
              n.dashArray
                ? i.setAttribute('stroke-dasharray', n.dashArray)
                : i.removeAttribute('stroke-dasharray'),
              n.dashOffset
                ? i.setAttribute('stroke-dashoffset', n.dashOffset)
    ...
    T.extend(T.SVG, {
      ...
      OY: function (t, i) {
        ...
        for (n = 0, o = t.length; n < o; n++) {
          for (r = t[n], e = 0, s = r.length; e < s; e++)
            (h = r[e]), (a += (e ? 'L' : 'M') + h.x + ' ' + h.y);
          a += i ? (T.oQ.MT ? 'z' : 'x') : '';
        }
        return a || 'M0 0';
      },
    ...
    (T.mT = T.ZT.extend({
        ...
        if (h) {
          for (
            this.SY[t.F] = t,
              a.beginPath(),
              a.setLineDash &&
                a.setLineDash((t.options && t.options._dashArray) || []),
              n = 0;
            n < h;
            n++
          ) {
            for (e = 0, o = r[n].length; e < o; e++)
              (s = r[n][e]), a[e ? 'lineTo' : 'moveTo'](s.x, s.y);
            i && a.closePath();
          }
          this.gY(a, t);
        }
      ...
      AY: function (t, i) {
        ...
        !n ||
          ...
          (T._Q.Tq(this.Ow, 'tdt-interactive'),
      ...
      jY: function (t, i) {
        ...
        for (n in this.SY)
          (e = this.SY[n]),
            e.options.mR &&
              e.HY(i) &&
              (T._Q.Rq(this.Ow, 'tdt-interactive'),
      ...
      for (o = 0, h = this.Lt.length; o < h; o++)
        for (i = this.Lt[o], s = 0, a = i.length, r = a - 1; s < a; r = s++)
          (n = i[s]),
            (e = i[r]),
            n.y > t.y != e.y > t.y &&
              t.x < ((e.x - n.x) * (t.y - n.y)) / (e.y - n.y) + n.x &&
              (u = !u);
    ...
    (T.GeoJSON = T.fT.extend({
      ...
      addData: function (t) {
        ...
        if (o) {
          for (i = 0, n = o.length; i < n; i++)
            (e = o[i]),
              (e.geometries || e.geometry || e.features || e.coordinates) &&
                this.addData(e);
          return this;
        }
        var s = this.options;
      ...
      resetStyle: function (t) {
        return (
          (t.options = T.S.extend({}, t.defaultOptions)),
    ...
    T.extend(T.GeoJSON, {
        ...
        switch (r.type) {
          ...
          case 'MultiPoint':
            for (o = 0, s = h.length; o < s; o++)
              (n = c(h[o])), a.push(u ? u(t, n) : new T.Marker(n));
            return new T.fT(a);
          case 'LineString':
          case 'MultiLineString':
            return (
              (e = this.coordsToLatLngs(h, 'LineString' === r.type ? 0 : 1, c)),
              new T.Polyline(e, i)
            );
          case 'Polygon':
          case 'MultiPolygon':
            return (
              (e = this.coordsToLatLngs(h, 'Polygon' === r.type ? 1 : 2, c)),
              new T.Polygon(e, i)
            );
      ...
      coordsToLatLngs: function (t, i, n) {
        for (var e, o = [], s = 0, r = t.length; s < r; s++)
          (e = i
            ? this.coordsToLatLngs(t[s], i - 1, n)
            : (n || this.coordsToLatLng)(t[s])),
            o.push(e);
        return o;
      },
      lY: function (t) {
    ...
    T.LayerGroup.M({
      ...
      toGeoJSON: function () {
        ...
        return (
          ...
          i
            ? T.GeoJSON.CY(this, { geometries: n, type: 'GeometryCollection' })
  ...
  (T.oq = {
    ...
    iT: function (t) {
      ...
      return (
        ...
        T.oq.on(t, { click: T.oq.hY, dblclick: i })
      );
    },
    ...
    Vw: function (t, i) {
      ...
      return new T.Point(
        t.clientX - n.left - i.clientLeft,
        t.clientY - n.top - i.clientTop
      );
    },
    ...
    bY: function (t, i) {
      var n = t.timeStamp || (t.originalEvent && t.originalEvent.timeStamp),
        e = T.oq.QU && n - T.oq.QU;
      return (e && e > 100 && e < 500) || (t.target.qU && !t.uE)
        ? void T.oq.uw(t)
        : ((T.oq.QU = n), void i(t));
    },
  }),
    ...
    (T.nY = T.m.extend({
      ...
      enable: function () {
        this.eU ||
          (T.oq.on(this.wU, T.nY.START.join(' '), this.RU, this),
          (this.eU = !0));
      },
      disable: function () {
        this.eU &&
          (T.oq.off(this.wU, T.nY.START.join(' '), this.RU, this),
          (this.eU = !1),
          (this.sw = !1));
      },
      RU: function (t) {
        if (
          ...
          (this.TU = new T.Point(i.clientX, i.clientY)),
            T.oq
              .on(document, T.nY.MOVE[t.type], this.fe, this)
              .on(document, T.nY.END[t.type], this.tU, this);
        }
      },
      fe: function (t) {
        if (!t.uE && this.eU) {
      ...
      tU: function (t) {
        if (!t.uE && this.eU) {
          ...
          for (var i in T.nY.MOVE)
            T.oq
              .off(document, T.nY.MOVE[i], this.fe, this)
              .off(document, T.nY.END[i], this.tU, this);
          T._Q.aq(),
            T._Q.Pq(),
    ...
    (T.Map.DU = T.Kr.extend({
      ...
      FU: function () {
        ...
        if (this.jE.options.maxBounds && this.jE.options.sU) {
          ...
          (this.KU = T.cQ(
            this.jE.BW(i.Zq()).fQ(-1),
            this.jE.BW(i.cq()).fQ(-1).AQ(this.jE.getSize())
          )),
            (this.kU = Math.min(1, Math.max(0, this.jE.options.sU)));
        } else this.KU = null;
        t.wQ('movestart').wQ('dragstart'),
          t.options.PU && ((this.JU = []), (this.jU = []));
      },
      fU: function (t) {
    ...
    (T.Map.MU = T.Kr.extend({
      ...
      nU: function (t) {
        ...
        return (
          !(o > i.getMaxZoom()) &&
          void ('center' === i.options.bU
            ? i.setZoom(o)
            : i.VW(t.containerPoint, o))
        );
      },
    })),
    T.Map.M({
    ...
    T.Map.n({ Ju: T.oQ.touch && !T.oQ.android23, ju: !1 }),
      ...
      Gu: function (t) {
        ...
        if (t.touches && 2 === t.touches.length && !i.ER && !this.ku) {
          ...
          (this.Lu = i.getSize().FQ(2)),
            ...
            'center' !== i.options.Ju &&
              (this._pinchStartLatLng = i.vW(n.AQ(e).FQ(2))),
            ...
            i.Iw(),
            T.oq
              .on(document, 'touchmove', this.gu, this)
              .on(document, 'touchend', this.Hu, this),
            T.oq.preventDefault(t);
        }
      },
      gu: function (t) {
        if (t.touches && 2 === t.touches.length && this.ku) {
          ...
          if (
            ...
            !i.options.ju &&
              ((this.fW < i.getMinZoom() && o < 1) ||
                (this.fW > i.getMaxZoom() && o > 1)) &&
            ...
            this.BT = i._q(
              i.nq(this._pinchStartLatLng, this.fW).sQ(s),
              this.fW
            );
          }
      ...
      Hu: function () {
        return this.sw && this.ku
          ? ((this.ku = !1),
            T.S.V(this.IU),
            T.oq
              .off(document, 'touchmove', this.gu)
              .off(document, 'touchend', this.Hu),
            void (this.jE.options.Nr
              ? this.jE.ge(
                  this.BT,
                  this.jE.GW(this.fW),
                  !0,
                  this.jE.options.snapZoom
                )
        ...
        if (t.touches) {
          ...
          (this.YU = this.uU = new T.Point(i.clientX, i.clientY)),
            n.tagName &&
              ...
              T._Q.Rq(n, 'tdt-active'),
            (this.vu = setTimeout(
              T.D(function () {
                this.Nu() &&
                  ((this.Bu = !1), this.tU(), this.bu('contextmenu', i));
              }, this),
              1e3
            )),
            this.bu('mousedown', i),
            T.oq.on(document, { touchmove: this.fe, touchend: this.tU }, this);
        }
      },
      tU: function (t) {
        if (
          (clearTimeout(this.vu),
          T.oq.off(document, { touchmove: this.fe, touchend: this.tU }, this),
    ...
    (T.Map.EI = T.Kr.extend({
      ...
      oU: function () {
        ...
        t.tabIndex <= 0 && (t.tabIndex = '0'),
          T.oq.on(
            t,
            { focus: this.rI, blur: this.TI, mousedown: this.nu },
            this
          ),
          this.jE.on({ focus: this.tI, blur: this.YI }, this);
      },
      Ar: function () {
        this.YI(),
          T.oq.off(
          ...
          this.jE.off({ focus: this.tI, blur: this.YI }, this);
      },
      nu: function () {
        if (!this.UI) {
          var t = document.body,
    ...
    (T.Kr.jr = T.Kr.extend({
      ...
      oU: function () {
        ...
        this.dU || (this.dU = new T.nY(t, t, !0)),
          this.dU
            .on({ dragstart: this.FU, drag: this.fU, dragend: this.GU }, this)
            .enable(),
          T._Q.Rq(t, 'tdt-marker-draggable');
      },
      Ar: function () {
        this.dU
          .off({ dragstart: this.FU, drag: this.fU, dragend: this.GU }, this)
          .disable(),
    ...
    (T.Control = T.c.extend({
      options: { position: T_ANCHOR_TOP_RIGHT },
      initialize: function (t) {
        T.setOptions(this, t);
      },
    ...
    T.Map._(function () {
      this.options.FI &&
        ((this.FI = new T.Control.Zoom()), this.addControl(this.FI));
    }),
    ...
    (T.Control.fI = T.Control.extend({
      options: {
        ...
        GI:
          ...
          T.w.e +
          '/logo.png" width="53px" height="22px" opacity="0"/><div style="display:inline;position:relative;bottom:4px;white-space:nowrap;padding:0 0 0 3px;">GS（2024）0568号 - 甲测资字1100471</div></div>',
      },
      initialize: function (t) {
      ...
      BE: function (t) {
        return t
          ? (this.gI[t] || (this.gI[t] = 0), this.gI[t]++, this.Oe(), this)
          : this;
      },
      NE: function (t) {
    ...
    (T.Control.Copyright = T.Control.fI.extend({
      options: { position: T_ANCHOR_BOTTOM_RIGHT, GI: '' },
      initialize: function (t) {
          ...
          for (var n = 0; n < this.hI.length; n++)
            this.hI[n].bounds &&
              (this.hI[n].bounds.contains(i)
                ? 'none' == this.hI[n]._span.style.display &&
                  (this.hI[n]._span.style.display = '')
    ...
    (T.Control.DataSources = T.Control.extend({
      options: { position: T_ANCHOR_BOTTOM_LEFT },
      initialize: function (t) {
      ...
      onAdd: function (t) {
        return (
          ...
          T.oq && T.oq.iT(this.Ow),
          (this.Ow.innerHTML =
            '<div style="height:24px">数据来源：国家地理信息公共服务平台</div>'),
          this.Oe(),
      ...
      getLayerArray: function () {
        for (
          var t = this.jE.getPanes().tilePane,
            i = ['vec', 'cva', 'ter', 'cta', 'img', 'cia'],
            n = [],
            e = 0;
          e < i.length;
          e++
          ...
          (this.dataSourcesInfo = ''),
            this.dataSources.search(r, function (t) {
              ...
              null != t.ds && 'null' != t.ds && (n = ' & ' + t.ds),
                ...
                (i.Ow.innerHTML =
                  '<div style="height:24px">数据来源：国家地理信息公共服务平台' +
                  n +
                  '</div>');
            }),
    ...
    (T.Control.Scale = T.Control.extend({
      ...
      setColor: function (t) {
        this.lI && ((this.lI.style.borderColor = t), (this.ZI.style.color = t)),
          this.CI &&
            1 == this.type &&
            ((this.CI.style.borderColor = t), (this.VI.style.color = t));
      },
      LI: function (t, i, n) {
        (this.type = t.type),
          t.KI &&
            ((this.lI = T._Q.s('div', i, n)),
      ...
      vI: function (t) {
        ...
        o > 5280
          ? ((i = o / 5280),
            (n = this.NI(i)),
            this.bI(this.VI, n + ' 英里', n / i, this.CI))
      ...
      NI: function (t) {
        var i = Math.pow(10, (Math.floor(t) + '').length - 1),
          n = t / i;
        return (
          (n = n >= 10 ? 10 : n >= 5 ? 5 : n >= 3 ? 3 : n >= 2 ? 2 : 1), i * n
        );
      },
    })),
    ...
    (T.Control.MI = T.Control.extend({
      options: { nI: !0, position: T_ANCHOR_TOP_RIGHT, _I: !0, mI: !1 },
      initialize: function (t, i, n) {
      ...
      removeLayer: function (t) {
        ...
        return (
          i && this.hW.splice(this.hW.indexOf(i), 1), this.jE ? this.Oe() : this
        );
      },
      expand: function () {
        ...
        return (
          t < this.ei.clientHeight
            ? (T._Q.Rq(this.ei, 'tdt-control-layers-scrollbar'),
              (this.ei.style.height = t + 'px'))
      ...
      Wi: function (t, i, n) {
        t.on('add remove', this.Ei, this),
          this.hW.push({ layer: t, name: i, overlay: n }),
      ...
      Oe: function () {
        ...
        return (
          this.options.mI &&
            ((t = t && o > 1), (this.Ti.style.display = t ? '' : 'none')),
      ...
      wi: function () {
        for (
          var t,
            i,
            n = this.ei.getElementsByTagName('input'),
            e = this.jE.getZoom(),
            o = n.length - 1;
          o >= 0;
          o--
    ...
    (T.Control.MapType = T.Control.extend({
      ...
      initialize: function (t, i) {
        T.S.l(arguments[0]) || ((i = t), this.Oi(), (t = T.w.oi)),
          ...
          this.options.manageLayers &&
            this.on('activelayerchange', this.Pi, this),
          this.pi(t);
      },
      Oi: function () {
        T.w.oi = [
      ...
      ai: function (t) {
        ...
        i &&
          ...
          this.Ow && this.Ai(),
          this.wQ('activelayerchange', { layer: t }));
      },
      expand: function () {
        this.Si()
          .slice(1)
      ...
      si: function (t) {
        ...
        return (
          t.icon &&
            i.setAttribute('style', "background-image: url('" + t.icon + "')"),
          i
        );
      },
      Gi: function () {
        for (
          var t, i, n = this.Si(), e = this.Di() && this.Di().id, o = 0;
          o < n.length;
          o++
        )
          o % this.options.maxLayersInRow === 0 &&
            ((t = T._Q.s('div', 'tdt-iconLayers-layersRow')),
            this.options.position.indexOf('bottom') === -1
              ? this.Ow.appendChild(t)
              : prepend(this.Ow, t)),
      ...
      gi: function (t) {
        ...
        var i =
            ...
            (t.currentTarget || t.target || t.srcElement).getAttribute(
              'data-layerid'
            )),
          n = this.hW[i];
    ...
    document.getElementsByClassName ||
      (document.getElementsByClassName = function (t, i) {
        for (
          ...
          for (
            var a = e[h].className.split(' '), u = (a.length, []), c = 0;
            c < r;
            c++
          )
    ...
    T.Map.M({
      gW: function (t, i, n) {
        if (
          ...
          void 0 !== n.Tw &&
            ((n.zoom = T.extend({ Tw: n.Tw }, n.zoom)),
            (n.qw = T.extend({ Tw: n.Tw, duration: n.duration }, n.qw)));
          var e =
            this.fW !== i ? this.Bi && this.Bi(t, i, n.zoom) : this.vi(t, n.qw);
      ...
      panBy: function (t, i) {
        if (((t = T.SQ(t).hQ()), (i = i || {}), !t.x && !t.y))
          return this.wQ('moveend');
        if (i.Tw !== !0 && !this.getSize().contains(t))
          return (
            this.ZW(this._q(this.nq(this.getCenter()).AQ(t)), this.getZoom()),
            this
          );
        if (
          (this.EE ||
            ((this.EE = new T.hi()),
            this.EE.on({ step: this.Ni, end: this.bi }, this)),
      ...
      vi: function (t, i) {
        var n = this.dE(t).KQ();
        return (
          !((i && i.Tw) !== !0 && !this.getSize().contains(n)) &&
          (this.panBy(n, i), !0)
        );
      },
    }),
  ...
  zoomAnimated &&
    ...
    T.Map.M(
      zoomAnimated
        ? {
            ...
            qO: function () {
              return !this.Ow.getElementsByClassName('tdt-zoom-animated')
                .length;
            },
            Bi: function (t, i, n) {
              if (this.ER) return !0;
              if (
                ...
                !this.ZE ||
                  n.Tw === !1 ||
                  this.qO() ||
                  Math.abs(i - this.fW) > this.options.Mi)
              )
                return !1;
              var e = this.cW(i),
            ...
            ge: function (t, i, n, e) {
              n &&
                ...
                this.wQ('Ge', { center: t, zoom: i, noUpdate: e }),
        ...
        function c() {
          ...
          n <= 1
            ? ((this.wE = T.S.C(c, this)),
              this.QE(
                this._q(l.AQ(f.sQ(l).fQ(a(e) / w)), p),
                this.gw(m / h(e), p),
                { Ne: !0 }
              ))
            : this.QE(t, i).mw(!0);
        }
        if (((n = n || {}), n.Tw === !1 || !T.oQ.any3d))
    ...
    T.Map.M({
      ...
      RO: function (t) {
        if (
          ((t = this.rO = T.extend({}, this.EO, t)),
          !('geolocation' in navigator))
        )
          return this.TO({ code: 0, message: 'tO' }), this;
      ...
      uO: function () {
        return (
          navigator.geolocation &&
            ...
            navigator.geolocation.clearWatch(this.UO),
      ...
      TO: function (t) {
        ...
        this.rO.gW && !this.CW && this.mW(),
          this.wQ('OO', { code: i, message: 'oO' + n + '.' });
      },
      YO: function (t) {
