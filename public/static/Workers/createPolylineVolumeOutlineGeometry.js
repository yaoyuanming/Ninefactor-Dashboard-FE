define([
...
], function (c, e, a, d, y, i, n, h, f, g, m, t, r, o, l, s, p, u, v, E, P) {
  'use strict';
  function _(e) {
    ...
    var t = 1 + i.length * d.Cartesian3.packedLength;
    (t += 1 + n.length * d.Cartesian2.packedLength),
      (this.packedLength = t + d.Ellipsoid.packedLength + 2);
  }
  ...
  var b = d.Ellipsoid.clone(d.Ellipsoid.UNIT_SPHERE),
    k = {
  ...
  _.unpack = function (e, i, n) {
    ...
    var l = d.Ellipsoid.unpack(e, i, b);
  ...
  return (
    (_.createGeometry = function (e) {
      ...
      if (!(n.length < 2 || t.length < 3)) {
        u.PolygonPipeline.computeWindingOrder2D(t) ===
          u.WindingOrder.CLOCKWISE && t.reverse();
        var a = l.BoundingRectangle.fromPoints(t, C);
        return (function (e, i) {
          ...
          var t = i.length,
            a = n.position.values.length / 3,
            r = e.length / 3 / t,
            o = m.IndexDatatype.createTypedArray(a, 2 * t * (1 + r)),
            l = 0,
            s = 0,
            p = s * t;
          for (u = 0; u < t - 1; u++) (o[l++] = u + p), (o[l++] = u + p + 1);
          for (
            o[l++] = t - 1 + p, o[l++] = p, p = (s = r - 1) * t, u = 0;
            u < t - 1;
            u++
          )
            (o[l++] = u + p), (o[l++] = u + p + 1);
          for (o[l++] = t - 1 + p, o[l++] = p, s = 0; s < r - 1; s++)
            for (var c = t * s, d = c + t, u = 0; u < t; u++)
              (o[l++] = u + c), (o[l++] = u + d);
          return new f.Geometry({
            attributes: n,
            indices: m.IndexDatatype.createTypedArray(a, o),
