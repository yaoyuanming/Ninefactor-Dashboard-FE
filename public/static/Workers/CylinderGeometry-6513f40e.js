define([
  ...
  (d.unpack = function (t, e, a) {
    ...
    var r = u.VertexFormat.unpack(t, e, f);
    ...
    return I.defined(a)
      ...
      : ((p.length = n),
        ...
        (p.bottomRadius = i),
        (p.slices = s),
        (p.offsetAttribute = -1 === m ? void 0 : m),
        new d(p));
  }),
    (d.createGeometry = function (t) {
      ...
      if (!(e <= 0 || a < 0 || r < 0 || (0 === a && 0 === r))) {
        var i = o + o,
          s = o + i,
          m = i + i,
          u = q.CylinderGeometryLibrary.computePositions(e, a, r, o, !0),
          d = n.st ? new Float32Array(2 * m) : void 0,
          f = n.normal ? new Float32Array(3 * m) : void 0,
          p = n.tangent ? new Float32Array(3 * m) : void 0,
          y = n.bitangent ? new Float32Array(3 * m) : void 0,
          l = n.normal || n.tangent || n.bitangent;
        if (l) {
          var c = n.tangent || n.bitangent,
            ...
            h = K;
          h.z = Math.sin(g);
          for (var x = Math.cos(g), _ = X, C = Q, F = 0; F < o; F++) {
            var w = (F / o) * U.CesiumMath.TWO_PI,
              G = x * Math.cos(w),
              D = x * Math.sin(w);
            l &&
              ((h.x = G),
              (h.y = D),
              c &&
                (_ = S.Cartesian3.normalize(
                  S.Cartesian3.cross(S.Cartesian3.UNIT_Z, h, _),
                  _
                )),
              n.normal &&
                ((f[b++] = h.x),
              ...
              n.tangent &&
                ...
                (p[v++] = _.z)),
              n.bitangent &&
                ((C = S.Cartesian3.normalize(S.Cartesian3.cross(h, _, C), C)),
                (y[A++] = C.x),
                (y[A++] = C.y),
                (y[A++] = C.z),
                (y[A++] = C.x),
          ...
          for (F = 0; F < o; F++)
            n.normal && ((f[b++] = 0), (f[b++] = 0), (f[b++] = -1)),
              n.tangent && ((p[v++] = 1), (p[v++] = 0), (p[v++] = 0)),
              n.bitangent && ((y[A++] = 0), (y[A++] = -1), (y[A++] = 0));
          for (F = 0; F < o; F++)
            n.normal && ((f[b++] = 0), (f[b++] = 0), (f[b++] = 1)),
              n.tangent && ((p[v++] = 1), (p[v++] = 0), (p[v++] = 0)),
              n.bitangent && ((y[A++] = 0), (y[A++] = 1), (y[A++] = 0));
        ...
        var R = 12 * o - 12,
          V = W.IndexDatatype.createTypedArray(m, R),
          T = 0,
          O = 0;
        for (F = 0; F < o - 1; F++)
          (V[T++] = O),
        ...
        for (
          ...
          (V[T++] = i + F + 1), (V[T++] = i + F), (V[T++] = i);
        for (F = 1; F < o - 1; F++)
          (V[T++] = s), (V[T++] = s + F), (V[T++] = s + F + 1);
        var L = 0;
        if (n.st) {
          var P = Math.max(a, r);
          for (F = 0; F < m; F++) {
            var k = S.Cartesian3.fromArray(u, 3 * F, $);
            (d[L++] = (k.x + P) / (2 * P)), (d[L++] = (k.y + P) / (2 * P));
          }
        }
        ...
        var z,
          E,
          N = new B.BoundingSphere(
            S.Cartesian3.ZERO,
            S.Cartesian2.magnitude(H)
          );
        return (
          I.defined(t._offsetAttribute) &&
            ((e = u.length),
            (z = new Uint8Array(e / 3)),
            (E = t._offsetAttribute === j.GeometryOffsetAttribute.NONE ? 0 : 1),
            j.arrayFill(z, E),
