define([
  ...
  (B.geometryOutlines =
    ...
    (b.pack = function (e, t, n) {
      ...
      var o = e._shape,
        a = o.length;
      for (t[n++] = a, r = 0; r < a; ++r, n += u.Cartesian2.packedLength)
  ...
  b.unpack = function (e, t, n) {
    ...
    for (
      var r = e[t++], i = new Array(r), a = 0;
      a < r;
      ++a, t += u.Cartesian3.packedLength
    )
      i[a] = u.Cartesian3.unpack(e, t);
    r = e[t++];
    var o = new Array(r);
    for (a = 0; a < r; ++a, t += u.Cartesian2.packedLength)
        ...
        return (function (e, t, n, r) {
          ...
          if (r.st || r.tangent || r.bitangent) {
            for (
              ...
              for (
                v = C * P, b = _ * (t[0].y + x), E[k++] = v, E[k++] = b, a = 1;
                a < d;
                a++
              )
                (b = _ * (t[a].y + x)),
                  ...
                  (E[k++] = v),
                  (E[k++] = b);
              (b = _ * (t[0].y + x)), (E[k++] = v), (E[k++] = b);
            }
            for (a = 0; a < d; a++)
              (v = 0), (b = _ * (t[a].y + x)), (E[k++] = v), (E[k++] = b);
            for (a = 0; a < d; a++)
              (v = (u - 1) * P),
                (b = _ * (t[a].y + x)),
                (E[k++] = v),
