define([
  ...
  var t, f, s;
  (c.fromCartesian4 = function (e, r) {
    return O.defined(r)
      ? ((r.red = e.x), (r.green = e.y), (r.blue = e.z), (r.alpha = e.w), r)
      : new c(e.x, e.y, e.z, e.w);
  }),
    (c.fromBytes = function (e, r, o, t, f) {
      return (
        (e = c.byteToFloat(O.defaultValue(e, 255))),
        (r = c.byteToFloat(O.defaultValue(r, 255))),
        (o = c.byteToFloat(O.defaultValue(o, 255))),
        (t = c.byteToFloat(O.defaultValue(t, 255))),
        O.defined(f)
          ? ((f.red = e), (f.green = r), (f.blue = o), (f.alpha = t), f)
          : new c(e, r, o, t)
      );
    }),
    (c.fromAlpha = function (e, r, o) {
      return O.defined(o)
        ? ((o.red = e.red),
          (o.green = e.green),
          (o.blue = e.blue),
    ...
    (c.fromRgba = function (e, r) {
      return (f[0] = e), c.fromBytes(s[0], s[1], s[2], s[3], r);
    }),
    (c.fromHsl = function (e, r, o, t, f) {
      ...
      return (
        0 !== r &&
          ...
          (a = i(n, s, e - 1 / 3))),
        O.defined(f)
          ? ((f.red = l), (f.green = C), (f.blue = a), (f.alpha = t), f)
          : new c(l, C, a, t)
      );
    }),
    (c.fromRandom = function (e, r) {
      var o,
        t,
        f = (e = O.defaultValue(e, O.defaultValue.EMPTY_OBJECT)).red;
      O.defined(f) ||
        ((o = O.defaultValue(e.minimumRed, 0)),
        (t = O.defaultValue(e.maximumRed, 1)),
        (f = o + g.CesiumMath.nextRandomNumber() * (t - o)));
      var s,
        n,
        l = e.green;
      O.defined(l) ||
        ((s = O.defaultValue(e.minimumGreen, 0)),
        (n = O.defaultValue(e.maximumGreen, 1)),
        (l = s + g.CesiumMath.nextRandomNumber() * (n - s)));
      var C,
        a,
        i = e.blue;
      O.defined(i) ||
        ((C = O.defaultValue(e.minimumBlue, 0)),
        (a = O.defaultValue(e.maximumBlue, 1)),
        (i = C + g.CesiumMath.nextRandomNumber() * (a - C)));
      var E,
        u,
        b = e.alpha;
      return (
        O.defined(b) ||
          ((E = O.defaultValue(e.minimumAlpha, 0)),
          (u = O.defaultValue(e.maximumAlpha, 1)),
          (b = E + g.CesiumMath.nextRandomNumber() * (u - E))),
        O.defined(r)
          ? ((r.red = f), (r.green = l), (r.blue = i), (r.alpha = b), r)
          : new c(f, l, i, b)
      );
    });
  ...
  (c.fromCssColorString = function (e, r) {
    O.defined(r) || (r = new c());
    var o = c[(e = e.replace(/\s/g, '')).toUpperCase()];
    if (O.defined(o)) return c.clone(o, r), r;
    var t = n.exec(e);
    return null !== t
      ? ((r.red = parseInt(t[1], 16) / 15),
        (r.green = parseInt(t[2], 16) / 15),
        (r.blue = parseInt(t[3], 16) / 15),
        (r.alpha = parseInt(O.defaultValue(t[4], 'f'), 16) / 15),
        r)
      : null !== (t = l.exec(e))
      ? ((r.red = parseInt(t[1], 16) / 255),
        (r.green = parseInt(t[2], 16) / 255),
        (r.blue = parseInt(t[3], 16) / 255),
        (r.alpha = parseInt(O.defaultValue(t[4], 'ff'), 16) / 255),
        r)
      : null !== (t = C.exec(e))
    ...
    (c.prototype.equalsEpsilon = function (e, r) {
      return (
        this === e ||
        (O.defined(e) &&
    ...
    (c.prototype.toCssColorString = function () {
      var e = c.floatToByte(this.red),
        ...
        o = c.floatToByte(this.blue);
      return 1 === this.alpha
        ? 'rgb(' + e + ',' + r + ',' + o + ')'
        : 'rgba(' + e + ',' + r + ',' + o + ',' + this.alpha + ')';
    }),
    (c.prototype.toCssHexString = function () {
      var e = c.floatToByte(this.red).toString(16);
      e.length < 2 && (e = '0' + e);
      var r = c.floatToByte(this.green).toString(16);
      r.length < 2 && (r = '0' + r);
      var o = c.floatToByte(this.blue).toString(16);
      if ((o.length < 2 && (o = '0' + o), this.alpha < 1)) {
        var t = c.floatToByte(this.alpha).toString(16);
        return t.length < 2 && (t = '0' + t), '#' + e + r + o + t;
      }
      return '#' + e + r + o;
    }),
    (c.prototype.toBytes = function (e) {
      var r = c.floatToByte(this.red),
        o = c.floatToByte(this.green),
        t = c.floatToByte(this.blue),
        f = c.floatToByte(this.alpha);
      return O.defined(e)
    ...
    (c.prototype.toRgba = function () {
      return (
        (s[0] = c.floatToByte(this.red)),
        (s[1] = c.floatToByte(this.green)),
        (s[2] = c.floatToByte(this.blue)),
        (s[3] = c.floatToByte(this.alpha)),
        f[0]
      );
    }),
