define(['exports', './when-54c2dc71', './Check-6c0211bc'], function (t, r, n) {
  'use strict';
  function i(t) {
      ...
      if (this.mti >= this.N) {
        for (
          ...
          (t =
            ...
            (this.mt[n] = this.mt[n + this.M] ^ (t >>> 1) ^ i[1 & t]);
        for (; n < this.N - 1; n++)
          (t =
            (this.mt[n] & this.UPPER_MASK) |
            (this.mt[n + 1] & this.LOWER_MASK)),
            (this.mt[n] =
              this.mt[n + (this.M - this.N)] ^ (t >>> 1) ^ i[1 & t]);
        (t =
          (this.mt[this.N - 1] & this.UPPER_MASK) |
          (this.mt[0] & this.LOWER_MASK)),
          (this.mt[this.N - 1] = this.mt[this.M - 1] ^ (t >>> 1) ^ i[1 & t]),
          (this.mti = 0);
      }
      return (
        (t = this.mt[this.mti++]),
  ...
  (h.sign = r.defaultValue(Math.sign, function (t) {
    ...
    (h.equalsEpsilon = function (t, n, i, a) {
      (i = r.defaultValue(i, 0)), (a = r.defaultValue(a, i));
      var e = Math.abs(t - n);
  ...
  (h.setRandomNumberSeed = function (t) {
    ...
    (h.fastApproximateAtan2 = function (t, n) {
      var i = Math.abs(t),
        ...
        e = Math.max(i, a),
        r = Math.min(i, a) / e,
        i = h.fastApproximateAtan(r);
      return (
        (i = Math.abs(n) > Math.abs(t) ? h.PI_OVER_TWO - i : i),
        (i = t < 0 ? h.PI - i : i),
        (i = n < 0 ? -i : i)
      );
    }),
