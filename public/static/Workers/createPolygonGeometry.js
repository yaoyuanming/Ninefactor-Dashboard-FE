define([
  ...
  './GeometryInstance-e56e7f4f',
  './arrayRemoveDuplicates-ebc732b0',
  './BoundingRectangle-6504da58',
  './EllipsoidTangentPlane-9a2d3381',
  './ArcType-dc1c5aee',
  './EllipsoidRhumbLine-c704bf4c',
  './PolygonPipeline-c425d4a8',
  './PolygonGeometryLibrary-818ff8da',
  ...
  'use strict';
  var J = new j.Cartographic(),
    X = new j.Cartographic();
  ...
  function B(e) {
    var t,
      ...
      c = e.top || u,
      p = e.bottom || u;
    if (o.st || o.normal || o.tangent || o.bitangent || n) {
      var y = e.boundingRectangle,
        m = e.tangentPlane,
        g = e.ellipsoid,
        d = e.stRotation,
        h = e.perPositionHeight,
        f = le;
      (f.x = y.x), (f.y = y.y);
      var b,
        v = o.st ? new Float32Array((l / 3) * 2) : void 0;
      o.normal &&
        (b = h && c && !u ? i.attributes.normal.values : new Float32Array(l));
      var _,
        P = o.tangent ? new Float32Array(l) : void 0,
        C = o.bitangent ? new Float32Array(l) : void 0,
        w = n ? new Float32Array(l) : void 0,
        x = 0,
        T = 0,
        I = ee,
        A = te,
      ...
      V =
        0 !== d
          ? ((_ = Q.Quaternion.fromAxisAngle(m._plane.normal, d, pe)),
            (O = Q.Matrix3.fromQuaternion(_, O)),
            (_ = Q.Quaternion.fromAxisAngle(m._plane.normal, -d, pe)),
            Q.Matrix3.fromQuaternion(_, V))
          : ((O = Q.Matrix3.clone(Q.Matrix3.IDENTITY, O)),
            Q.Matrix3.clone(Q.Matrix3.IDENTITY, V));
      var F = 0,
        D = 0;
      c && p && ((F = l / 2), (D = l / 3), (l /= 2));
      for (var L = 0; L < l; L += 3) {
        var N,
          ...
          k,
          z,
          W = j.Cartesian3.fromArray(s, L, ce);
        o.st &&
          ((N = Q.Matrix3.multiplyByVector(O, W, $)),
          (N = g.scaleToGeodeticSurface(N, N)),
          (H = m.projectPointOntoPlane(N, ue)),
          j.Cartesian2.subtract(H, f, H),
          (R = U.CesiumMath.clamp(H.x / y.width, 0, 1)),
          (M = U.CesiumMath.clamp(H.y / y.height, 0, 1)),
          p && ((v[x + D] = R), (v[x + 1 + D] = M)),
          c && ((v[x] = R), (v[x + 1] = M)),
          (x += 2)),
          (o.normal || o.tangent || o.bitangent || n) &&
            ((S = T + 1),
            (B = T + 2),
            u
              ? (L + 3 < l &&
                  ((k = j.Cartesian3.fromArray(s, L + 3, ae)),
                  G &&
                    ((z = j.Cartesian3.fromArray(s, L + l, oe)),
                    h &&
                      (function (e, t, r, a) {
                        var o = a.cartesianToCartographic(e, J).height,
                          i = a.cartesianToCartographic(t, X);
                        (i.height = o), a.cartographicToCartesian(i, t);
                        var n = a.cartesianToCartographic(r, X);
                        (n.height = o - 100), a.cartographicToCartesian(n, r);
                      })(W, k, z, g),
                    j.Cartesian3.subtract(k, W, k),
                    j.Cartesian3.subtract(z, W, z),
                    (I = j.Cartesian3.normalize(
                      j.Cartesian3.cross(z, k, I),
                      I
                    )),
                    (G = !1)),
                  j.Cartesian3.equalsEpsilon(k, W, U.CesiumMath.EPSILON10) &&
                    (G = !0)),
                (o.tangent || o.bitangent) &&
                  ((E = g.geodeticSurfaceNormal(W, E)),
                  o.tangent &&
                    (A = j.Cartesian3.normalize(
                      j.Cartesian3.cross(E, I, A),
                      A
                    ))))
              : ((I = g.geodeticSurfaceNormal(W, I)),
                (o.tangent || o.bitangent) &&
                  (h &&
                    ((ie = j.Cartesian3.fromArray(b, T, ie)),
                    (ne = j.Cartesian3.cross(j.Cartesian3.UNIT_Z, ie, ne)),
                    (ne = j.Cartesian3.normalize(
                      Q.Matrix3.multiplyByVector(V, ne, ne),
                      ne
                    )),
                    o.bitangent &&
                      (se = j.Cartesian3.normalize(
                        j.Cartesian3.cross(ie, ne, se),
                        se
                      ))),
                  (A = j.Cartesian3.cross(j.Cartesian3.UNIT_Z, I, A)),
                  (A = j.Cartesian3.normalize(
                    Q.Matrix3.multiplyByVector(V, A, A),
                    A
                  )),
                  o.bitangent &&
                    (E = j.Cartesian3.normalize(
                      j.Cartesian3.cross(I, A, E),
                      E
                    )))),
            o.normal &&
              (e.wall
                ? ((b[T + F] = I.x), (b[S + F] = I.y), (b[B + F] = I.z))
                : p &&
                  ((b[T + F] = -I.x), (b[S + F] = -I.y), (b[B + F] = -I.z)),
              ((c && !h) || u) && ((b[T] = I.x), (b[S] = I.y), (b[B] = I.z))),
            n &&
              (u && (I = g.geodeticSurfaceNormal(W, I)),
              (w[T + F] = -I.x),
              (w[S + F] = -I.y),
              (w[B + F] = -I.z)),
            o.tangent &&
              (e.wall
                ? ((P[T + F] = A.x), (P[S + F] = A.y), (P[B + F] = A.z))
                : p &&
                  ((P[T + F] = -A.x), (P[S + F] = -A.y), (P[B + F] = -A.z)),
              c &&
                (h
                  ? ((P[T] = ne.x), (P[S] = ne.y), (P[B] = ne.z))
                  : ((P[T] = A.x), (P[S] = A.y), (P[B] = A.z)))),
            o.bitangent &&
              (p && ((C[T + F] = E.x), (C[S + F] = E.y), (C[B + F] = E.z)),
              c &&
                (h
                  ? ((C[T] = se.x), (C[S] = se.y), (C[B] = se.z))
                  : ((C[T] = E.x), (C[S] = E.y), (C[B] = E.z)))),
            (T += 3));
      }
      o.st &&
        (i.attributes.st = new K.GeometryAttribute({
          componentDatatype: q.ComponentDatatype.FLOAT,
          componentsPerAttribute: 2,
          values: v,
        })),
        o.normal &&
          (i.attributes.normal = new K.GeometryAttribute({
            componentDatatype: q.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: b,
          })),
        o.tangent &&
          (i.attributes.tangent = new K.GeometryAttribute({
            componentDatatype: q.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: P,
          })),
        o.bitangent &&
          (i.attributes.bitangent = new K.GeometryAttribute({
            componentDatatype: q.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: C,
          })),
        n &&
          (i.attributes.extrudeDirection = new K.GeometryAttribute({
            componentDatatype: q.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: w,
          }));
    ...
    return (
      e.extrude &&
        Y.defined(e.offsetAttribute) &&
        ((t = s.length / 3),
        (a = new Uint8Array(t)),
        e.offsetAttribute === Z.GeometryOffsetAttribute.TOP
          ? (c && p) || u
            ? (a = Z.arrayFill(a, 1, 0, t / 2))
            : c && (a = Z.arrayFill(a, 1))
          : ((r = e.offsetAttribute === Z.GeometryOffsetAttribute.NONE ? 0 : 1),
            (a = Z.arrayFill(a, r))),
        (i.attributes.applyOffset = new K.GeometryAttribute({
  ...
  function _(e, t, r, a) {
    for (
      ...
      var u = e.interpolateUsingSurfaceDistance(s, v);
      s += n;
      var c = u.longitude,
        p = u.latitude;
  ...
  function P(e) {
    var t,
      ...
      a = Y.defaultValue(e.vertexFormat, b.VertexFormat.DEFAULT),
      o = Y.defaultValue(e.ellipsoid, j.Ellipsoid.WGS84),
      i = Y.defaultValue(e.granularity, U.CesiumMath.RADIANS_PER_DEGREE),
      n = Y.defaultValue(e.stRotation, 0),
      s = Y.defaultValue(e.perPositionHeight, !1),
      l = s && Y.defined(e.extrudedHeight),
      u = Y.defaultValue(e.height, 0),
      c = Y.defaultValue(e.extrudedHeight, u);
    l || ((t = Math.max(u, c)), (c = Math.min(u, c)), (u = t)),
      (this._vertexFormat = b.VertexFormat.clone(a)),
      (this._ellipsoid = j.Ellipsoid.clone(o)),
      (this._granularity = i),
      (this._stRotation = n),
      (this._height = u),
      ...
      (this.packedLength =
        M.PolygonGeometryLibrary.computeHierarchyPackedLength(r) +
  ...
  return (
    (P.unpack = function (e, t, r) {
      ...
      var i = b.VertexFormat.unpack(e, t, w);
      ...
      if (!(c.length < 3)) {
        ...
        if (0 !== m.length) {
          ...
          if (
            ...
            !U.CesiumMath.equalsEpsilon(b, v, 0, U.CesiumMath.EPSILON2)
          )
            for (
              _.extrude = !0,
                _.top = s,
              ...
              var P,
                C = (function (e, t, r, a, o, i, n, s, l) {
                  var u = { walls: [] };
                  if (i || n) {
                    var c =
                        M.PolygonGeometryLibrary.createGeometryFromPositions(
                          e,
                          t,
                          r,
                          o,
                      ...
                      p = c.attributes.position.values,
                      y = c.indices;
                    if (i && n) {
                      var m,
                        g = p.concat(p),
                        d = g.length / 3;
                      (m = L.IndexDatatype.createTypedArray(
                        d,
                        2 * y.length
                      )).set(y);
                      for (
                        var h, f = y.length, b = d / 2, v = 0;
                        v < f;
                        v += 3
                      ) {
                        var _ = m[v] + b,
                          P = m[v + 1] + b,
                          C = m[v + 2] + b;
                        (m[v + f] = C), (m[v + 1 + f] = P), (m[v + 2 + f] = _);
                      }
                      (c.attributes.position.values = g),
                        o &&
                          s.normal &&
                          ((h = c.attributes.normal.values),
                          (c.attributes.normal.values = new Float32Array(
                            g.length
                          )),
                          c.attributes.normal.values.set(h)),
                        (c.indices = m);
                    } else if (n) {
                      for (
                        d = p.length / 3,
                          m = L.IndexDatatype.createTypedArray(d, y.length),
                          v = 0;
                        v < y.length;
                        v += 3
                      )
                    ...
                    u.topAndBottom = new N.GeometryInstance({ geometry: c });
                  }
                  var w = a.outerRing,
                    x = H.EllipsoidTangentPlane.fromPoints(
                      w,
                      e
                    ).projectPointsOntoPlane(w, k);
                  R.PolygonPipeline.computeWindingOrder2D(x) ===
                    R.WindingOrder.CLOCKWISE && (w = w.slice().reverse());
                  var T = M.PolygonGeometryLibrary.computeWallGeometry(
                    w,
                    e,
                    r,
                    o,
                  ...
                  u.walls.push(new N.GeometryInstance({ geometry: T }));
                  var I = a.holes;
                  for (v = 0; v < I.length; v++) {
                    var A = I[v],
                      x = H.EllipsoidTangentPlane.fromPoints(
                        A,
                        e
                      ).projectPointsOntoPlane(A, k);
                    R.PolygonPipeline.computeWindingOrder2D(x) ===
                      R.WindingOrder.COUNTER_CLOCKWISE &&
                      (A = A.slice().reverse()),
                      (T = M.PolygonGeometryLibrary.computeWallGeometry(
                        A,
                        e,
                        r,
                        o,
            ...
            for (d = 0; d < g.length; d++) {
              ...
              (G.geometry.attributes.position.values =
                ...
                (_.geometry = G.geometry),
                (G.geometry = B(_)),
                Y.defined(e._offsetAttribute) &&
                  ((I = G.geometry.attributes.position.values.length),
                  (A = new Uint8Array(I / 3)),
                  (E =
                    e._offsetAttribute === Z.GeometryOffsetAttribute.NONE
                      ? 0
                      : 1),
                  Z.arrayFill(A, E),
                  (G.geometry.attributes.applyOffset = new K.GeometryAttribute({
                    componentDatatype: q.ComponentDatatype.UNSIGNED_BYTE,
                    componentsPerAttribute: 1,
                    values: A,
                  }))),
