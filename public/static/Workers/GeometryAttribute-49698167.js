define([
  ...
  (v.packedLength = 4),
    ...
    (v.clone = function (t, e) {
      if (a.defined(t))
        return a.defined(e)
          ...
          : new v(t[0], t[2], t[1], t[3]);
    }),
    (v.fromArray = function (t, e, n) {
      return (
        (e = a.defaultValue(e, 0)),
        a.defined(n) || (n = new v()),
        (n[0] = t[e]),
    ...
    (v.fromColumnMajorArray = function (t, e) {
      return v.clone(t, e);
    }),
    (v.fromRowMajorArray = function (t, e) {
      return a.defined(e)
        ? ((e[0] = t[0]), (e[1] = t[2]), (e[2] = t[1]), (e[3] = t[3]), e)
        : new v(t[0], t[1], t[2], t[3]);
    }),
    (v.fromScale = function (t, e) {
      return a.defined(e)
        ? ((e[0] = t.x), (e[1] = 0), (e[2] = 0), (e[3] = t.y), e)
        : new v(t.x, 0, 0, t.y);
    }),
    (v.fromUniformScale = function (t, e) {
      return a.defined(e)
        ? ((e[0] = t), (e[1] = 0), (e[2] = 0), (e[3] = t), e)
        : new v(t, 0, 0, t);
    }),
    (v.fromRotation = function (t, e) {
      var n = Math.cos(t),
        r = Math.sin(t);
      return a.defined(e)
    ...
    (v.toArray = function (t, e) {
      return a.defined(e)
        ? ((e[0] = t[0]), (e[1] = t[1]), (e[2] = t[2]), (e[3] = t[3]), e)
        : [t[0], t[1], t[2], t[3]];
    }),
    (v.getElementIndex = function (t, e) {
      return 2 * t + e;
    }),
    (v.getColumn = function (t, e, n) {
      var r = 2 * e,
        a = t[r],
        i = t[1 + r];
      return (n.x = a), (n.y = i), n;
    }),
    (v.setColumn = function (t, e, n, r) {
      var a = 2 * e;
      return ((r = v.clone(t, r))[a] = n.x), (r[1 + a] = n.y), r;
    }),
    (v.getRow = function (t, e, n) {
      var r = t[e],
        a = t[e + 2];
      return (n.x = r), (n.y = a), n;
    }),
    (v.setRow = function (t, e, n, r) {
      return ((r = v.clone(t, r))[e] = n.x), (r[e + 2] = n.y), r;
    });
  var i = new O.Cartesian2();
  v.getScale = function (t, e) {
    return (
  ...
  (v.getMaximumScale = function (t) {
    return v.getScale(t, u), O.Cartesian2.maximumComponent(u);
  }),
    (v.multiply = function (t, e, n) {
    ...
    (v.multiplyByVector = function (t, e, n) {
      var r = t[0] * e.x + t[2] * e.y,
        a = t[1] * e.x + t[3] * e.y;
      return (n.x = r), (n.y = a), n;
    }),
    (v.multiplyByScalar = function (t, e, n) {
      return (
        (n[0] = t[0] * e),
        (n[1] = t[1] * e),
        (n[2] = t[2] * e),
    ...
    (v.multiplyByScale = function (t, e, n) {
      return (
        (n[0] = t[0] * e.x),
        (n[1] = t[1] * e.x),
        (n[2] = t[2] * e.y),
    ...
    (v.equalsEpsilon = function (t, e, n) {
      return (
        (n = a.defaultValue(n, 0)),
        t === e ||
          (a.defined(t) &&
    ...
    (v.IDENTITY = Object.freeze(new v(1, 0, 0, 1))),
    ...
    (v.prototype.clone = function (t) {
      return v.clone(this, t);
    }),
    (v.prototype.equals = function (t) {
      return v.equals(this, t);
    }),
    (v.prototype.equalsEpsilon = function (t, e) {
      return v.equalsEpsilon(this, t, e);
    }),
  ...
  f.computeNumberOfVertices = function (t) {
    ...
    for (var r in t.attributes) {
      t.attributes.hasOwnProperty(r) &&
        a.defined(t.attributes[r]) &&
        a.defined(t.attributes[r].values) &&
        (n = (e = t.attributes[r]).values.length / e.componentsPerAttribute);
    }
    return n;
  };
  ...
  (f._textureCoordinateRotationPoints = function (t, e, n, r) {
    var a = O.Rectangle.center(r, R),
      i = O.Cartographic.toCartesian(a, n, V),
      u = M.Transforms.eastNorthUpToFixedFrame(i, n, P),
      o = M.Matrix4.inverse(u, P),
      s = _,
      f = G;
    (f[0].longitude = r.west),
      (f[0].latitude = r.south),
      (f[1].longitude = r.west),
      (f[1].latitude = r.north),
      (f[2].longitude = r.east),
      (f[2].latitude = r.south);
    for (var c = B, l = 0; l < 3; l++)
      O.Cartographic.toCartesian(f[l], n, c),
        (c = M.Matrix4.multiplyByPointAsVector(o, c, c)),
        (s[l].x = c.x),
        (s[l].y = c.y);
    var d = M.Quaternion.fromAxisAngle(O.Cartesian3.UNIT_Z, -e, F),
      y = M.Matrix3.fromQuaternion(d, k),
      m = t.length,
    ...
    for (l = 0; l < m; l++)
      (c = M.Matrix4.multiplyByPointAsVector(o, t[l], c)),
        (c = M.Matrix3.multiplyByVector(y, c, c)),
        (p = Math.min(p, c.x)),
        (h = Math.min(h, c.y)),
        (N = Math.max(N, c.x)),
        (I = Math.max(I, c.y));
    var C = v.fromRotation(e, Y),
      b = W;
    (b[0].x = p),
      (b[0].y = h),
      (b[1].x = p),
