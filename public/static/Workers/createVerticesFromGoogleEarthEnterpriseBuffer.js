define([
...
], function (Wt, t, Ft, Ot, Yt, kt, e, i, n, r, a, Ut, o, Vt, Ht, Lt) {
  'use strict';
  ...
  function Jt(t, e, i) {
    ...
    for (var n = t.length, r = 0; r < n; ++r)
      if (i.equalsEpsilon(t[r], e, Ft.CesiumMath.EPSILON12)) return r;
    return -1;
  }
  var Kt = new Ot.Cartographic(),
    ...
    $t = new Yt.Matrix4();
  function te(t, e, i, n, r, a, o, s, u, h) {
    for (var c = o.length, d = 0; d < c; ++d) {
      var g = o[d],
        ...
        I = l.longitude,
        v = l.latitude,
        v = Ft.CesiumMath.clamp(
          v,
          -Ft.CesiumMath.PI_OVER_TWO,
          Ft.CesiumMath.PI_OVER_TWO
        ),
        E = l.height - a.skirtHeight;
      (a.hMin = Math.min(a.hMin, E)),
        Ot.Cartographic.fromRadians(I, v, E, Kt),
        u && (Kt.longitude += s),
        u
          ? d === c - 1
            ? (Kt.latitude += h)
            : 0 === d && (Kt.latitude -= h)
          : (Kt.latitude += s);
      var T = a.ellipsoid.cartographicToCartesian(Kt);
      t.push(T),
        e.push(E),
        i.push(Ot.Cartesian2.clone(i[m])),
        0 < n.length && n.push(n[m]),
        Yt.Matrix4.multiplyByPoint(a.toENU, T, Qt);
      var f = a.minimum,
        C = a.maximum;
      Ot.Cartesian3.minimumByComponent(Qt, f, f),
        Ot.Cartesian3.maximumByComponent(Qt, C, C);
      var M,
        N = a.lastBorderPoint;
      Wt.defined(N) && ((M = N.index), r.push(M, p - 1, p, p, m, M)),
        (a.lastBorderPoint = g);
    }
  }
  return o(function (t, e) {
    ...
    var i = (function (t, e, i, n, r, a, o, s, u, h) {
        var c, d, g, l, m, p;
        p = Wt.defined(n)
          ? ((c = n.west),
            (d = n.south),
            ...
            (m = n.width),
            n.height)
          : ((c = Ft.CesiumMath.toRadians(r.west)),
            (d = Ft.CesiumMath.toRadians(r.south)),
            (g = Ft.CesiumMath.toRadians(r.east)),
            (l = Ft.CesiumMath.toRadians(r.north)),
        ...
        var I,
          ...
          E = [d, l],
          T = [c, g],
          f = Yt.Transforms.eastNorthUpToFixedFrame(e, i),
          C = Yt.Matrix4.inverseTransformation(f, $t);
        s &&
          ((I = Ut.WebMercatorProjection.geodeticLatitudeToMercatorAngle(d)),
          (v =
            1 /
            (Ut.WebMercatorProjection.geodeticLatitudeToMercatorAngle(l) - I)));
        ...
        for (P = B = 0; P < 4; ++P) {
          ...
          B += Gt;
          var nt = M.getInt32(B, !0);
          (B += Gt), (B += Gt);
          for (var rt = new Array(it), at = 0; at < it; ++at) {
          ...
          for (var lt = 3 * nt, mt = 0; mt < lt; ++mt, ++J)
            (L[J] = rt[M.getUint16(B, !0)]), (B += Dt);
        ...
        {
          var Tt, ft, Ct;
          te(k, V, U, H, L, vt, D, -Et * m, !0, -Et * p),
            te(k, V, U, H, L, vt, G, -Et * p, !1),
            te(k, V, U, H, L, vt, j, Et * m, !0, Et * p),
            te(k, V, U, H, L, vt, z, Et * p, !1),
            0 < D.length &&
              0 < z.length &&
              ((Tt = D[0].index),
              (ft = z[z.length - 1].index),
              (Ct = k.length - 1),
              L.push(ft, Ct, pt, pt, Tt, ft));
        }
        y = k.length;
        var Mt,
          Nt = Yt.BoundingSphere.fromPoints(k);
        Wt.defined(n) &&
          (Mt = Ht.OrientedBoundingBox.fromRectangle(n, N, x, i));
        for (
          var xt = new Lt.EllipsoidalOccluder(
            ...
            St = new Lt.TerrainEncoding(bt, vt.hMin, x, f, !1, s),
