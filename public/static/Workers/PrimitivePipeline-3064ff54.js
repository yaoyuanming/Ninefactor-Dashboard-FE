define([
...
], function (e, v, t, c, P, k, C, w, b, A, f) {
  'use strict';
  function m(e, t, r) {
  ...
  function x(e) {
    var t,
      ...
      p = r.length;
    for (y = 0; y < p; ++y)
      if (v.defined(r[y].geometry)) {
        r[y].geometry.primitiveType;
        break;
      }
    if (
      (!(function (e, t, r) {
      ...
      for (y = 0; y < p; ++y)
        v.defined(r[y].geometry) && b.GeometryPipeline.splitLongitude(r[y]);
    if (
      (!(function (e) {
    ...
    var c = b.GeometryPipeline.combineInstances(r);
    for (p = c.length, y = 0; y < p; ++y) {
      var f,
        m,
        h,
        l = (t = c[y]).attributes;
      if (o)
        for (f in l)
          l.hasOwnProperty(f) &&
            l[f].componentDatatype === k.ComponentDatatype.DOUBLE &&
            b.GeometryPipeline.encodeAttribute(t, f, f + '3DHigh', f + '3DLow');
      else
        for (f in l) {
          l.hasOwnProperty(f) &&
            l[f].componentDatatype === k.ComponentDatatype.DOUBLE &&
            ((m = f + '3D'),
            (h = f + '2D'),
            b.GeometryPipeline.projectTo2D(t, f, m, h, n),
            v.defined(t.boundingSphere) &&
              'position' === f &&
            ...
            b.GeometryPipeline.encodeAttribute(t, h, h + 'High', h + 'Low'));
        }
      s && b.GeometryPipeline.compressVertices(t);
    }
    if (!i) {
      for (var g = [], p = c.length, y = 0; y < p; ++y)
        (t = c[y]),
          (g = g.concat(b.GeometryPipeline.fitToUnsignedShortIndices(t)));
      c = g;
    }
    return c;
  }
  function S(e, t, r, n) {
    ...
    s =
      0 <= d
        ? ((o = (i = n[d]).offset + i.count), r[(a = i.index)].indices.length)
        : r[(a = o = 0)].indices.length;
    for (var p = e.length, u = 0; u < p; ++u) {
      var c,
        f = e[u][t];
      v.defined(f) &&
        (s < o + (c = f.indices.length) &&
          ((o = 0), (s = r[++a].indices.length)),
        n.push({ index: a, offset: o, count: c }),
        (o += c));
    }
  }
    ...
    for (var r = e.length, n = 0; n < r; ++n)
      !(function (e, t) {
        ...
        for (var i in n) {
          n.hasOwnProperty(i) &&
            ((r = n[i]),
            v.defined(r) && v.defined(r.values) && t.push(r.values.buffer));
        }
  ...
  (h.combineGeometry = function (e) {
    ...
    0 < p &&
      ...
      v.defined(d[0].attributes) &&
        ...
        ((i = new Array(p)), (u = !0)));
    for (var c = new Array(p), f = new Array(p), m = 0; m < p; ++m) {
      var h = d[m],
        l = h.geometry;
      v.defined(l) &&
        ((c[m] = l.boundingSphere),
        (f[m] = l.boundingSphereCV),
    ...
    (h.packCreateGeometryResults = function (e, t) {
      ...
      for (var s = 0; s < o; s++) {
        ...
        if (((r[a++] = p ? 1 : 0), p)) {
          ...
          var c = v.defined(d.boundingSphereCV) ? 1 : 0;
          (r[a++] = c) && P.BoundingSphere.pack(d.boundingSphereCV, r, a),
            (a += P.BoundingSphere.packedLength);
          var f = d.attributes,
            m = [];
          for (var h in f)
      ...
      return {
        ...
        packedInstances: (function (e, t) {
          ...
          for (var o = 0; o < r; o++) {
            var a,
              s = e[o];
            P.Matrix4.pack(s.modelMatrix, n, i),
              (i += P.Matrix4.packedLength),
              v.defined(s.attributes) &&
                v.defined(s.attributes.offset) &&
                ((a = s.attributes.offset.value),
                (n[i] = a[0]),
                (n[i + 1] = a[1]),
                (n[i + 2] = a[2])),
              (i += 3);
    ...
    (h.packCombineGeometryResults = function (e, t) {
      v.defined(e.geometries) && i(e.geometries, t);
