define([
  ...
  (R.subdivideRhumbLineCount = function (e, t, r, i) {
    ...
    (R.subdivideLine = function (e, t, r, i) {
      ...
      for (var u, l, c, h, f = 0, p = 0; p < n; p++) {
        var d =
          ...
          E.Cartesian3.multiplyByScalar(g, c / h, g),
    ...
    (R.subdivideRhumbLine = function (e, t, r, i, n) {
      var a = e.cartesianToCartographic(t, m),
        ...
        c = Math.pow(2, l),
        h = s.surfaceDistance / c;
      I.defined(n) || (n = []);
      var f = n;
      f.length = 3 * c;
      for (var p = 0, d = 0; d < c; d++) {
        var y = s.interpolateUsingSurfaceDistance(d * h, b),
  ...
  (R.computeBoundingRectangle = function (e, t, r, i, n) {
    ...
    return (n.x = s), (n.y = l), (n.width = u - s), (n.height = c - l), n;
  }),
