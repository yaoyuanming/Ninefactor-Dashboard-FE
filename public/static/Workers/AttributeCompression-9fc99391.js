define([
      ...
      octEncodeInRange: function (t, o, e) {
        ...
        return (
          ...
          t.z < 0 &&
            ((n = e.x),
            (a = e.y),
            (e.x = (1 - Math.abs(a)) * c.CesiumMath.signNotZero(n)),
            (e.y = (1 - Math.abs(n)) * c.CesiumMath.signNotZero(a))),
          (e.x = c.CesiumMath.toSNorm(e.x, o)),
          (e.y = c.CesiumMath.toSNorm(e.y, o)),
          e
        );
      },
  ...
  (s.octEncodeToCartesian4 = function (t, o) {
    ...
    (s.octDecodeInRange = function (t, o, e, n) {
      var a;
      return (
        (n.x = c.CesiumMath.fromSNorm(t, e)),
        (n.y = c.CesiumMath.fromSNorm(o, e)),
        (n.z = 1 - (Math.abs(n.x) + Math.abs(n.y))),
        n.z < 0 &&
          ((a = n.x),
          (n.x = (1 - Math.abs(n.y)) * c.CesiumMath.signNotZero(a)),
          (n.y = (1 - Math.abs(a)) * c.CesiumMath.signNotZero(n.y))),
  ...
  (s.octEncodeFloat = function (t) {
    ...
    (s.octPack = function (t, o, e, n) {
      var a = s.octEncodeFloat(t),
        c = s.octEncodeFloat(o),
        r = s.octEncode(e, i);
      return (n.x = 65536 * r.x + a), (n.y = 65536 * r.y + c), n;
    }),
    (s.octUnpack = function (t, o, e, n) {
      var a = t.x / 65536,
        ...
        i = Math.floor(a),
        u = 65536 * (a - i);
      s.octDecodeFloat(r, o), s.octDecodeFloat(u, e), s.octDecode(c, i, n);
    }),
