define([
  ...
  'use strict';
  function E(e) {
    var t = (e = i.defaultValue(e, i.defaultValue.EMPTY_OBJECT))
      .polygonHierarchy;
    ...
    (E.createGeometry = function (e) {
      ...
      if (
        ...
        if (0 !== n.length) {
          ...
          var c = m.GeometryPipeline.combineInstances(o)[0],
            y = p.BoundingSphere.fromPoints(t.positions);
          return new u.Geometry({
