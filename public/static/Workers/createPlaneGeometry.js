define([
...
], function (a, e, t, c, p, r, n, y, s, A, o) {
  'use strict';
  function m(e) {
    e = a.defaultValue(e, a.defaultValue.EMPTY_OBJECT);
    var t = a.defaultValue(e.vertexFormat, o.VertexFormat.DEFAULT);
    (this._vertexFormat = t), (this._workerName = 'createPlaneGeometry');
  }
  (m.packedLength = o.VertexFormat.packedLength),
  ...
  var i = new o.VertexFormat(),
    u = { vertexFormat: i };
  m.unpack = function (e, t, r) {
    t = a.defaultValue(t, 0);
    var n = o.VertexFormat.unpack(e, t, i);
    return a.defined(r)
      ? ((r._vertexFormat = o.VertexFormat.clone(n, r._vertexFormat)), r)
      : new m(u);
  };
  ...
  return (
    ...
    function (e, t) {
      return a.defined(t) && (e = m.unpack(e, t)), m.createGeometry(e);
    }
  );
});
