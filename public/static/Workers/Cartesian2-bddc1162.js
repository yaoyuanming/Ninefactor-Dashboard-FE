define([
  ...
  b.lerp = function (e, t, n, a) {
    return (
      b.multiplyByScalar(t, n, r),
      (a = b.multiplyByScalar(e, 1 - n, a)),
      b.add(r, a, a)
    );
  };
  var u = new b(),
  ...
  function l(e, t, n, a, r) {
    ...
    var g = n.x,
      ...
      x = n.z,
      w = E;
    (w.x = p.x * g * 2), (w.y = p.y * M * 2), (w.z = p.z * x * 2);
    var v,
      _,
      C,
      z,
  ...
  function x(e, t, n, a) {
    (t = R.defaultValue(t, 0)),
      ...
      (e._radiiToTheFourth = new b(
        t * t * t * t,
        n * n * n * n,
        a * a * a * a
      )),
      (e._oneOverRadii = new b(
        0 === t ? 0 : 1 / t,
        0 === n ? 0 : 1 / n,
        0 === a ? 0 : 1 / a
      )),
  ...
  (f.fromCartesian = function (e, t, n) {
    var a = R.defined(t) ? t.oneOverRadii : p,
      ...
      i = l(e, a, r, R.defined(t) ? t._centerToleranceSquared : M, m);
    if (R.defined(i)) {
    ...
    (w.fromCartesian3 = function (e, t) {
      return (
        R.defined(t) || (t = new w()), R.defined(e) && x(t, e.x, e.y, e.z), t
      );
    }),
    ...
    (w.prototype.geodeticSurfaceNormal = function (e, t) {
      if (!b.equalsEpsilon(e, b.ZERO, V.CesiumMath.EPSILON14))
        return (
          R.defined(t) || (t = new b()),
  ...
  (w.prototype.cartographicToCartesian = function (e, t) {
    ...
    this.geodeticSurfaceNormalCartographic(e, n),
      b.multiplyComponents(this._radiiSquared, n, a);
  ...
  (w.prototype.cartesianToCartographic = function (e, t) {
    ...
    (w.prototype.transformPositionToScaledSpace = function (e, t) {
      return (
        R.defined(t) || (t = new b()),
        b.multiplyComponents(e, this._oneOverRadii, t)
      );
    }),
    (w.prototype.transformPositionFromScaledSpace = function (e, t) {
      return (
        R.defined(t) || (t = new b()), b.multiplyComponents(e, this._radii, t)
      );
    }),
  ...
  function T(e, t, n) {
    for (var a = 0.5 * (t + e), r = 0.5 * (t - e), i = 0, u = 0; u < 5; u++) {
      var o = r * q[u];
      i += O[u] * (n(a + o) + n(a - o));
    }
    return (i *= r);
  ...
  (w.prototype.surfaceArea = function (e) {
    for (var t = e.west, n = e.east, a = e.south, r = e.north; n < t; )
      n += V.CesiumMath.TWO_PI;
    var i = this._radiiSquared,
      u = i.x,
      o = i.y,
      d = i.z,
      s = u * o;
    return T(a, r, function (e) {
      ...
      return (
        ...
        T(t, n, function (e) {
          var t = Math.cos(e),
            n = Math.sin(e);
          return Math.sqrt(s * r * r + d * (o * t * t + u * n * n) * a * a);
        })
      );
    });
  }),
    Object.defineProperties(A.prototype, {
      width: {
        get: function () {
          return A.computeWidth(this);
        },
      },
      height: {
        get: function () {
          return A.computeHeight(this);
        },
      },
    }),
    (A.packedLength = 4),
    ...
    (A.computeWidth = function (e) {
      var t = e.east,
        n = e.west;
      return t < n && (t += V.CesiumMath.TWO_PI), t - n;
    }),
    (A.computeHeight = function (e) {
      return e.north - e.south;
    }),
    (A.fromDegrees = function (e, t, n, a, r) {
      return (
    ...
    (A.fromRadians = function (e, t, n, a, r) {
      return R.defined(r)
    ...
    (A.fromCartographicArray = function (e, t) {
      for (
        ...
        var h = e[d],
          ...
          l =
            0 <= h.longitude ? h.longitude : h.longitude + V.CesiumMath.TWO_PI,
          r = Math.min(r, l),
          i = Math.max(i, l);
      return (
        i - r < a - n &&
    ...
    (A.fromCartesianArray = function (e, t, n) {
      ...
      for (
        ...
        var l = t.cartesianToCartographic(e[s]),
          ...
          f =
            0 <= l.longitude ? l.longitude : l.longitude + V.CesiumMath.TWO_PI,
          i = Math.min(i, f),
          u = Math.max(u, f);
      return (
        u - i < r - a &&
      ...
      if (R.defined(e))
        return R.defined(t)
          ? ((t.west = e.west),
            ...
            (t.north = e.north),
            t)
          : new A(e.west, e.south, e.east, e.north);
    }),
    ...
    (A.intersection = function (e, t, n) {
      var a = e.east,
        r = e.west,
        i = t.east,
        u = t.west;
      a < r && 0 < i
        ? (a += V.CesiumMath.TWO_PI)
        : i < u && 0 < a && (i += V.CesiumMath.TWO_PI),
        a < r && u < 0
          ? (u += V.CesiumMath.TWO_PI)
          : i < u && r < 0 && (r += V.CesiumMath.TWO_PI);
    ...
    (A.simpleIntersection = function (e, t, n) {
    ...
    (A.contains = function (e, t) {
      ...
      return (
        i < r &&
          ((i += V.CesiumMath.TWO_PI), n < 0 && (n += V.CesiumMath.TWO_PI)),
  ...
  (A.subsample = function (e, t, n, a) {
    ...
    for (var h = 1; h < 8; ++h)
      (s.longitude = -Math.PI + h * V.CesiumMath.PI_OVER_TWO),
        A.contains(e, s) && ((a[r] = t.cartographicToCartesian(s, a[r])), r++);
    return (
      0 === s.latitude &&
        ((s.longitude = d),
        (a[r] = t.cartographicToCartesian(s, a[r])),
    ...
    (N.fromElements = function (e, t, n) {
      return R.defined(n) ? ((n.x = e), (n.y = t), n) : new N(e, t);
    }),
    (N.fromCartesian3 = N.clone =
      function (e, t) {
        if (R.defined(e))
          return R.defined(t) ? ((t.x = e.x), (t.y = e.y), t) : new N(e.x, e.y);
      }),
    (N.fromCartesian4 = N.clone),
    (N.packedLength = 2),
    ...
    (N.packArray = function (e, t) {
      ...
      for (var r = 0; r < n; ++r) N.pack(e[r], t, 2 * r);
      return t;
    }),
    (N.unpackArray = function (e, t) {
      var n = e.length;
      R.defined(t) ? (t.length = n / 2) : (t = new Array(n / 2));
      for (var a = 0; a < n; a += 2) {
        var r = a / 2;
        t[r] = N.unpack(e, a, t[r]);
      }
      return t;
    }),
    (N.fromArray = N.unpack),
    (N.maximumComponent = function (e) {
      return Math.max(e.x, e.y);
    }),
    (N.minimumComponent = function (e) {
      return Math.min(e.x, e.y);
    }),
    (N.minimumByComponent = function (e, t, n) {
      return (n.x = Math.min(e.x, t.x)), (n.y = Math.min(e.y, t.y)), n;
    }),
    (N.maximumByComponent = function (e, t, n) {
  ...
  (N.distance = function (e, t) {
    return N.subtract(e, t, U), N.magnitude(U);
  }),
    (N.distanceSquared = function (e, t) {
      return N.subtract(e, t, U), N.magnitudeSquared(U);
    }),
    ...
    (N.multiplyComponents = function (e, t, n) {
      return (n.x = e.x * t.x), (n.y = e.y * t.y), n;
    }),
    (N.divideComponents = function (e, t, n) {
      return (n.x = e.x / t.x), (n.y = e.y / t.y), n;
    }),
    ...
    (N.divideByScalar = function (e, t, n) {
      return (n.x = e.x / t), (n.y = e.y / t), n;
    }),
  ...
  var L = new N();
  N.lerp = function (e, t, n, a) {
    return (
      N.multiplyByScalar(t, n, L),
      (a = N.multiplyByScalar(e, 1 - n, a)),
      N.add(L, a, a)
    );
  };
  var W = new N(),
  ...
  N.angleBetween = function (e, t) {
    return (
      N.normalize(e, W),
      N.normalize(t, k),
      V.CesiumMath.acosClamped(N.dot(W, k))
    );
  };
  var B = new N();
  (N.mostOrthogonalAxis = function (e, t) {
    var n = N.normalize(e, B);
    return (
      N.abs(n, n),
      (t = n.x <= n.y ? N.clone(N.UNIT_X, t) : N.clone(N.UNIT_Y, t))
    );
  }),
    ...
    (N.equalsEpsilon = function (e, t, n, a) {
      return (
        e === t ||
        (R.defined(e) &&
          R.defined(t) &&
    ...
    (N.UNIT_X = Object.freeze(new N(1, 0))),
    (N.UNIT_Y = Object.freeze(new N(0, 1))),
    ...
    (N.prototype.equalsEpsilon = function (e, t, n) {
      return N.equalsEpsilon(this, e, t, n);
    }),
