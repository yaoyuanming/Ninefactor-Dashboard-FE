define([
  ...
  return (
    (y.unpack = function (e, t, r) {
      var i = p.EllipsoidGeometry.unpack(e, t, f);
      return (
        (G.vertexFormat = u.VertexFormat.clone(
          i._vertexFormat,
          G.vertexFormat
        )),
        (G.stackPartitions = i._stackPartitions),
        (G.slicePartitions = i._slicePartitions),
        a.defined(r)
          ? (o.Cartesian3.clone(i._radii, G.radii),
            (r._ellipsoidGeometry = new p.EllipsoidGeometry(G)),
            r)
          : ((G.radius = i._radii.x), new y(G))
      );
    }),
